...
export default () => (
  <div>
    ...
    <Note>
      ...
      back end code for a "real" website, we will just simulate this with a fake
      API.
    </Note>
      ...
      <ol>
        <li>
          ...
          <ol style={{ listStyleType: "upper-roman" }}>
            ...
            <li>
              Being asynchronous means that you can load data (and code) prior
              to rendering a new page instead of rendering loading screens while
              you wait for data to be fetched.
            </li>
          </ol>
        </li>
        <li>
          Curi is response based. Whenever navigation happens, Curi will create
          a new response object by matching itsroutes to the new location. The
          response will then be emitted so that the application can re-render
    ...
    <Section title="Prerequisites" id="prereqs">
      ...
      <ol>
        ...
        <li>
          ...
          frameworks that you can use with Curi, but they <em>are</em> the only
          ones that this tutorial is (currently) written for.
        </li>
      </ol>
    </Section>
