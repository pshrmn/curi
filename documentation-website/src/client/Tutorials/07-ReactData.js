...
const BookList = ({ response }) => (
  <div className='book-list'>
    ...
    <div className='books'>
      ...
      <Note>
        If our render function (passed to the <Cmp>CuriProvider</Cmp>) had just
        passed the <IJS>params</IJS> instead of the whole <IJS>response</IJS>,
        we would have to modify that function to also pass along the{" "}
        <IJS>data</IJS>. Since we pass the entire <IJS>response</IJS>, we do not
        have to worry about updating that function.
      </Note>
    </Section>
