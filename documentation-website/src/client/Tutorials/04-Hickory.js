...
export default () => (
  <BaseTutorial>
    ...
    <Section title="Choose your own Hickory" id="choose">
      ...
      <p>
        We will be using the browser history (<IJS>@hickory/browser</IJS>). This
        is because 1. our application will run in the browser and 2. our site is
        backed by a server that can handle dynamic requests.
      </p>
    </Section>
    ...
    <Section title="Making History" id="making-history">
      <p>
