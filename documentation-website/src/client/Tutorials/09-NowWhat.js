...
export default () => (
  <BaseTutorial>
    ...
    <p>
      ...
      works, and hopefully you learned a lot while we built it.
    </p>
    <p>
    ...
    <p>
      ...
      build your own website! The tutorial went through everything you need to
      know to get started building a site with Curi, so why not build your own?
    </p>
    <p>
    ...
    <ol>
      <li>
        The current home page is quite boring. You could add a "featured" book
        to it using the "Home" route's <IJS>match.response</IJS> function to
        attach a random book to the response.
      </li>
      <li>
        Similar to the previous suggestion, the contact page could use some work
        as well. Perhaps you could add some child routes for different methods
        of contact.
      </li>
      <li>
      ...
      <li>
        ...
        covered what you need to know to get started, but there is plenty more
        you can dive into for advanced usage.
      </li>
    </ol>
  </BaseTutorial>
);
