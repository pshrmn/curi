...
export default () => (
  <BaseTutorial>
    <h1>Part 8: Rendering Data with React</h1>
    <p>
    ...
    >
      <p>
        Currently, in our <IJS>BookList.js</IJS> file, we are importing
  ...
  <div>
    ...
    <div>
      ...
      <Note>
        ...
        <IJS>response</IJS>, we do not have to worry about updating that function.
      </Note>
    </Section>
    <Section
      title='Book'
