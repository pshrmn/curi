  ...
  <BaseTutorial>
    ...
    <Section title="Pages" id="pages">
      ...
      <p>
        ...
        may either be static (literal) or dynamic (include parts that change,
        like IDs).
      </p>
      <ol>
        <li>
        ...
        <li>
          Contact - <IJS>/contact</IJS>
        </li>
        <li>
          Book list - <IJS>/books</IJS>
        </li>
        <li>
          Book - <IJS>/books/&lt;book id&gt;</IJS> e.g. <IJS>/books/2468</IJS>
        </li>
        <li>
          Checkout - <IJS>/checkout</IJS>
        </li>
      </ol>
    </Section>
    ...
    <Section title="Routes" id="routes">
      ...
      <Note>
        <IJS>path-to-regexp</IJS> provides pathname matching. You give it a path
        string (possibly with special formatting) and it returns a regular
        expression that can be used for matching routes. The regular expression
      ...
      <p>
        ...
        slash. For all of the pathnames for pages that are listed above, we just
  ...
  children: [
    {
      ...
      <p>
        Now, we can go ahead and use path params and route children to define
    ...
    children: [
      ...
      <Subsection title="route.match" id="route-match">
        ...
        <p>
          ...
          just use the route's name as a placeholder.
        </p>
        <PrismBlock lang="javascript">
          {`const routes = [
  {
  ...
  },
  {
    ...
    children: [
      ...
      <Subsection title="Wildcard Routes" id="wildcard">
        <p>
          We have one last "route" to define. This isn't really a route, just a
          catch all that we can use to identify locations that we don't have a
          route defined for. <IJS>path-to-regexp</IJS> allows us to capture
...
export default routes;`}
      ...
      <Subsection title="Route Order" id="order">
        ...
        <p>
          ...
          pathname is <IJS>'/somewhere'</IJS>, because our "Book List" route
          does not match, Curi will not attempt to match our "Book" route.
        </p>
      </Subsection>
    </Section>
