...
export default () => (
  <BaseTutorial>
    <h1>Part 6: Rendering Data with Vue</h1>
    <p>
    ...
    <TutorialBranch name="06-render-data-vue" />
    <Section title="Using Data with the Book List" id="book-list">
      <p>
        ...
        <IJS>response</IJS> to access our data. Since we also have better data,
        we can now use each book's title for the link text.
      </p>
      <PrismBlock lang="html" data-line="6-14">
...
<template>
  <div class='book-list'>
    ...
    <Section title="Using Data with the Book" id="book">
      ...
      <PrismBlock lang="html" data-line="3-11,14-23">
...
<script>
  export default {
    ...
    <Section title="Review" id="review">
      ...
      <CompleteBranch name="07-nav-vue" />
      <CodeSandboxDemo id="github/pshrmn/curi-tutorial/tree/07-nav-vue" />
    </Section>
    <Section title="Next" id="next">
      <p>
        ...
        a book. In{" "}
        <Link to="Tutorial" params={{ name: "07-nav-vue" }}>
