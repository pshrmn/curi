          ...
          {`// a sample response object
{
  ...
  status: 200
        ...
        <p>
          The navigation object contains additional information about a
          navigation that doesn't make sense to include in the response object.
          This includes the navigation's "action" (<IJS>PUSH</IJS>,{" "}
...
// session = ['/one', '/two', '/new'], index = 2`}`}
      ...
      <p>
        ...
        built-in add-on: <IJS>pathname</IJS>. The <Cmp>Link</Cmp>
