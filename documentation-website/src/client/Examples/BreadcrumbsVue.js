...
export default ({ name }) => (
  <BaseExample>
    ...
    <Section
      ...
      id='demo'
    >
      <CodeSandboxDemo id='github/pshrmn/curi/tree/master/examples/breadcrumbs-vue' />
    </Section>
    ...
    >
      ...
      <a href='https://github.com/pshrmn/curi/tree/master/examples/breadcrumbs-vue'>here</a>.
    </Section>
  </BaseExample>
);
