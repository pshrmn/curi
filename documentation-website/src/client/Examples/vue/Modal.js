...
export default ({ name }) => (
  <BaseExample>
    ...
    <Section title="Explanation" id="explanation">
      <p>
        This example mimics the way that Pinterest works. Whether or not this is
        a good design pattern is up for debate, but at the very least it is
      ...
      <p>
        ...
        attach a value to the location that indicates that you want to render a
        modal. State is persistent across refreshes and the user clicking the
        browser's forward/back buttons, so you will also have to take that into
        consideration.
      </p>

      <p>
        Second, <IJS>navigation.previous</IJS> is used to render the base layer
        displayed under the modal.
      </p>
