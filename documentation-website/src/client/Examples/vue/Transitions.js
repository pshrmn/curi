...
export default ({ name }) => (
  <BaseExample>
    ...
    <Section title="Explanation" id="explanation">
      <p>
        You can easily animate transitions between locations with Vue using the
        <Cmp>transition</Cmp> component.
      </p>
      <p>
        If you will be transitioning between the same route (i.e. using params),
        you will need to attach a <IJS>key</IJS> to the <Cmp>component</Cmp>.
      </p>
