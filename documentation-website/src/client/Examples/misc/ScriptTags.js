  ...
  <BaseExample>
    ...
    <Section title="Explanation" id="explanation">
      ...
      <p>
        ...
        <IJS>curi</IJS> package is globally available as <IJS>Curi</IJS> and the{' '}
        <IJS>curi-react</IJS> package is globally available as{' '}
        <IJS>CuriReact</IJS>.
      </p>
    </Section>
    ...
    <Section title="On GitHub" id="source">
      ...
      GitHub{' '}
      <a href="https://github.com/pshrmn/curi/tree/master/examples/umd-example">
        here
      </a>.
    </Section>
  </BaseExample>
