...
export default ({ name }) => (
  ...
  config.respond((response, action) => {
    ...
    res.send(renderFullPage(markup));
      ...
      <ul>
        <li>
          Data loading — You would need to maintain two copies of your routes if
          you want to handle data fetching on the server differently than it
          works on the client side. This is not something that I have explored
          very closely yet, so I don't have any recommendations on exactly how
          to approach this.
        </li>
        <li>
          ...
          building your client side bundle. The solution used in this experiment
          is to use the <IJS>env</IJS> property.
          <PrismBlock lang="javascript">
            {`{
  ...
  "env": {
    ...
    <Section title="On GitHub" id="source">
      ...
      GitHub{' '}
      <a href="https://github.com/pshrmn/curi/tree/master/examples/server-rendering">
        here
      </a>.
    </Section>
  </BaseExample>
