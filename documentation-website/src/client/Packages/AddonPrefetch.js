...
export default ({ name, version, globalName }) => (
  <BasePackage
    ...
    about={
      <p>
        The prefetch addon can be used to make data fetching calls prior to
        navigation by calling a route's <IJS>load</IJS> function. This is
...
`}
        ...
        <p>
          The prefetch addon allows you to call a route's load function
        ...
        <Note>
          ...
          in your load functions. The load function will be recalled when the
          user actually navigates to the route, so the benefit comes from the
          load function using a cached value instead of sending a new request to
          your server.
        </Note>
...
config.addons.prefetch('User', { id: 2 })`}
        ...
        <p>
          This addon will only register routes that have a load function in
          their load object.
        </p>
      </Section>
    </APIBlock>
