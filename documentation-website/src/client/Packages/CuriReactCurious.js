...
`import curious from '@curi/react-curious';`
      ...
      <p>
        The curious higher-order component creates a component that has a <IJS>curi</IJS> and
        <IJS>response</IJS> props. The curi prop is your application's configuration object.
