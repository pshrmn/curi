...
up to date version of the `curi` UMD build, open https://unpkg.com/curi-react-clickable/umd in your
browser and copy the link address for the `curi-react-clickable.js` file. That will provide you
