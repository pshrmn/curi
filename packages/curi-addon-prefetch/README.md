...
up to date version of the `curi` UMD build, open https://unpkg.com/curi-addon-prefetch/umd in your
browser and copy the link address for the `curi-addon-prefetch.js` file. That will provide you
