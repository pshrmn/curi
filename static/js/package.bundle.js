...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BasePackage.default, {
    ...
    lang: "javascript"
  }, "const prefixedTitle = createTitleSideEffect({ prefix: 'Before'});\n// response.title = 'Middle'\n// document.title = 'Before Middle';\n\nconst suffixedTitle = createTitleSideEffect({ suffix: 'After'});\n// response.title = 'Middle'\n// document.title = 'Middle After';"), _react.default.createElement("p", null, "A ", _react.default.createElement(_PrismBlocks.InlineJS, null, "delimiter"), " can be specified for joining the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "prefix"), " and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "suffix"), " to the title string. Spaces will be placed between the prefix, title, and suffix strings and the delimiters."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const prefixedTitle = createTitleSideEffect({\n  prefix: 'Before',\n  suffix: 'After',\n  delimiter: '&'\n});\n// response.title = 'Middle'\n// document.title = 'Before & Middle & After';"), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const prefixedTitle = createTitleSideEffect({ prefix: 'Before'});\n// response.title = 'Middle'\n// document.title = 'Before Middle';\n\nconst suffixedTitle = createTitleSideEffect({ suffix: 'After'});\n// response.title = 'Middle'\n// document.title = 'Middle After';"), _react.default.createElement("p", null, "A ", _react.default.createElement(_PrismBlocks.InlineJS, null, "delimiter"), " can be specified for joining the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "prefix"), " and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "suffix"), " to the title string. Spaces will be placed between the prefix, title, and suffix strings and the delimiters."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
...
var _default = function _default(_ref) {
  ...
  }, _react.default.createElement("p", null, "When registering the side effect, you should pass the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "after: true"), " option. This should make the side effect run after your application has re-rendered (although this is not guaranteed if your application is rendered asynchronously)."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BasePackage.default, {
    ...
    title: _react.default.createElement(_PrismBlocks.InlineComponent, null, "CuriBase"),
    id: "CuriBase"
  }, _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "CuriBase"), " component places values on React's", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "context"), " so that child components can access them."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "import { CuriBase } from '@curi/react';"), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "jsx"
    ...
    title: "render",
    id: "CuriBase-render"
  }, _react.default.createElement("p", null, "A render function. This will be called whenever the", ' ', _react.default.createElement(_PrismBlocks.InlineComponent, null, "CuriBase"), " renders. The function will be passed the current response object and the config object it was passed as a prop. The function must return a React element.")), _react.default.createElement(_Sections.Subsection, {
    tag: "h4",
    title: "response",
    id: "CuriBase-response"
  }, _react.default.createElement("p", null, "A response object. You can pass your ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "CuriBase"), " a response object and it will use that instead of subscribing to the configuration object. This is ideal for server-side rendering.")), _react.default.createElement(_Sections.Subsection, {
    tag: "h4",
    title: "action",
    id: "CuriBase-action"
  }, _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineJS, null, "action"), " from the most recent navigation (the second argument passed to ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config.respond"), " callbacks). This prop is optional.")))), _react.default.createElement(_Sections.Section, {
  ...
  }, _react.default.createElement(_PrismBlocks.InlineComponent, null, "CuriBase")), ' ', "as an ancestor of your ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Active"), "components in order to ensure that those exist."))), _react.default.createElement(_Sections.Section, {
...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BasePackage.default, {
    ...
    version: version,
    globalName: globalName,
    about: _react.default.createElement("p", null, "This package allows you to synchronize the response objects generated by Curi with your Redux store. Whenever location changes occur, they will be dispatched to your store. If you use this (with a React application), you do not have to use the ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "CuriBase"), ".")
...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BasePackage.default, {
    ...
    lang: "javascript"
  }, "import { Store } from 'svelte/store';\n\nconst config = createConfig(history, routes);\nconst store = new Store({\n  curi: { config }\n});"), _react.default.createElement("p", null, "As far as rendering your application goes, you should use the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "respond"), " method provided by the Curi configuration object to re-render whenever a new response is emitted."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BasePackage.default, {
    ...
    title: "installCuri",
    id: "installCuri"
  }), _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineJS, null, "installCuri"), " will install a Vue plugin that adds Curi support to your Vue instance. This will also automatically subscribe to your Curi configuration object so that your application will re-render whenever a new response is emitted."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "import { installCuri } from '@curi/vue';\n\nconst config = createConfig(history, routes);\ninstallCuri(Vue, config);"), _react.default.createElement(_Sections.Section, {
    tag: "h3",
    title: "CuriPlugin",
    id: "curiplugin"
  }, _react.default.createElement("p", null, "If you would prefer to install the Curi Vue plugin yourself, you can also import it directly."), _react.default.createElement("p", null, "What does the plugin do? First, it will register ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "curi-link"), ' ', "and ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "curi-block"), " components with Vue. You can use these components anywhere within your application. Second, it makes your configuration object and any response/action properties reactive Vue properties. These values are grouped under the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "$curi"), ' ', "variable as ", _react.default.createElement(_PrismBlocks.InlineJS, null, "$curi.config"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "$curi.response"), ", and", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "$curi.action"), "."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "import { CuriPlugin } from '@curi/vue';\n\nconst config = createConfig(history, routes);\nVue.use(CuriPlugin, { config });"), _react.default.createElement(_Sections.Subsection, {
    tag: "h4",
    title: "Components",
    id: "components"
    ...
    lang: "javascript"
  }, "// renderFunction.js\nimport Nav from './Nav';\nexport default function renderFunction(h) {\n  return h('div', [\n    h(Nav),\n    h(this.$curi.resp.body)\n  ]);\n}"), _react.default.createElement("p", null, "While ", _react.default.createElement(_PrismBlocks.InlineJS, null, "installCuri"), " subscribes to your config object, you will still need to wait for it to emit its first update before you can render. To do that, you can pass the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "{ once: true }"), ' ', "option to a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config.respond"), " call."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BasePackage.default, {
    ...
    id: "respond"
  }, _react.default.createElement("p", null, "The returned object provides a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "respond"), " method that allows your application to be informed of navigation. It expects to be passed a function, which will be called whenever a new response is generated."), _react.default.createElement("p", null, "If the best-matched route has either a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "match.initial"), " or", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "match.every"), " loading function, the configuration object will not call the subscribed functions until the loading functions have all resolved."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
    ...
    lang: "javascript"
  }, "{ once: true } // default false\n// When true, the response handler function will only be called once. When\n// once is true, config.respond does not return an unsubscribe function."))), _react.default.createElement(_Sections.Subsection, {
    tag: "h5",
    title: "addons",
    id: "addons"
