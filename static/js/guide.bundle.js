...
var _Load = _interopRequireDefault(__webpack_require__(88));
...
var _default = function _default(_ref) {
  var name = _ref.name;
  return _react.default.createElement(_BaseGuide.default, null, _react.default.createElement("h1", null, name), _react.default.createElement("p", null, "Curi aims to be easy to setup. To get started, you just need to create a Hickory history object and an array of route objects. Pass those as arguments to the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "createConfig"), " function to create your configuration object. Then, subscribe to the configuration object using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config.subscribe()"), ". The function you pass to ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config.subscribe"), " will be called every time the location changes. You can use this to (re-)render your application based on the response."), _react.default.createElement(_Sections.Section, {
...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BaseGuide.default, null, _react.default.createElement("h1", null, name), _react.default.createElement("p", null, "Routes are simply JavaScript objects with two required props: name and path. There are also a number of other props that you can use to enhance the routes. We will cover these below."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    ...
    lang: "javascript"
  }, "// when the pathname is '/a/Good+Kid,+M.A.A.D+City/Poetic+Justice',\n// the Album route will partially match. However, because it sets\n// end to false, the partial match will be used.\n{\n  name: 'Album',\n  path: 'a/:albumID',\n  pathOptions: {\n    end: false\n  }\n}"), _react.default.createElement("p", null, "If none of your routes match a pathname, then Curi will set a \"404\" status on the response object. The body property of the response will also be ", _react.default.createElement(_PrismBlocks.InlineJS, null, "undefined"), ", so it is important that your application checks the response's status when it goes to render a response. You can also add a wildcard route (", _react.default.createElement(_PrismBlocks.InlineJS, null, "path: '*'"), ") to the end of your routes array, and that route will always match. You may want to still manually set the status to \"404\" for the wildcard route, but it is not required.")), _react.default.createElement(_Sections.Section, {
    ...
    title: "body",
    id: "body"
  }, _react.default.createElement("p", null, "The body property gives you the opportunity to set the body property of a response for a given route. This must be a function and its return value will be what is set as the response object's body property."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "// when the user visits /contact, the response object's body\n// property will be the Contact value\nconst contact = {\n  name: 'Contact',\n  path: 'contact',\n  body: () => Contact\n};"), _react.default.createElement("p", null, "While the above example returns a single value, you might have multiple page values that you want to associate with a route. In that case, you can return an object with a property for each one. Then, when you render the application, you would access the values using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.body.<property-name>"), ".", ' ', "If you take this approach, each route's ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " function should return an object with the same properties."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
    ...
    title: "preload",
    id: "preload"
  }, _react.default.createElement("p", null, "A function that will only be called the first time that a route matches. This should only be used for loading resources that are required for the route to display properly. For example, if you are doing code splitting with Webpack using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "import()"), ", you would load the modules in preload."), _react.default.createElement("p", null, "The preload function must return a Promise."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const about = {\n  name: 'About',\n  path: 'about',\n  preload: () => {\n    return import('./components/About')\n      .then(module => AsyncStore.register(module.default));\n  }\n};")), _react.default.createElement(_Sections.Subsection, {
    title: "load",
    id: "load"
  }, _react.default.createElement("p", null, "A function that can be used for data fetching as well as for triggering redirects. The load function will be passed the a \"route\" object containing the params object that is parsed from the location's pathname (using the route and its ancestor's paths), the current location, and then name of the matched route. Additionally, it will be passed a modifiers object that can be used to modify the response object that will be created and an object containing all of the registered Curi addons (the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "pathname"), " addon being particularly useful)."), _react.default.createElement("p", null, "Like preload, load must return a Promise."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "// set response data\nconst user = {\n  name: 'User',\n  path: ':id',\n  load: ({ params, location }, mod, addons) => {\n    return fetch(`/api/users/${params.id}`)\n      .then(resp => JSON.parse(resp))\n      .then(data => mod.setData(data);)\n      .catch(err => {\n        mod.fail(err);\n        mod.setStatus(404);\n      });\n  }\n}\n\n// set a permanent redirect\nconst routes = [\n  {\n    name: 'Photo',\n    path: 'p/:id'\n  },\n  {\n    name: 'Old Photo',\n    path: 'photo/:id',\n    load: ({ params, location }, mod, addons) => {\n      const pathname = addons.pathname('Photo', params);\n      mod.redirect({ ...location, pathname }, 301);\n    }\n  }\n]\n// navigating to /photo/123 will automatically redirect to /p/123"), _react.default.createElement("p", null, "What is that modifiers object that gets passed to the load function? It contains a number of functions that you can use to modify the response. These functions are ", _react.default.createElement(_PrismBlocks.InlineJS, null, "redirect"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "fail"), ",", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "setStatus"), ", and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "setData"), "."), _react.default.createElement("ul", null, _react.default.createElement("li", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "redirect(to, code)"), " - This allows you to turn the response into a redirect response. When you application receives a redirect response, it should redirect to the new location (using your history object) instead of re-rendering. If you do not provide a code, then 301 will be used. Setting the status code is mostly important for rendering on the server. The ", _react.default.createElement(_PrismBlocks.InlineJS, null, "to"), " argument should be a string or a location object. Once the response has been created, Curi will automatically redirect to the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "to"), " location."), _react.default.createElement("li", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "fail(error)"), " - A method to call when something goes wrong. This will add an error property to the response."), _react.default.createElement("li", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "setStatus(code)"), " - This method will set a new status for the response (the default status is 200 when a route matches and 404 when no routes match)."), _react.default.createElement("li", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "setData(data)"), " - The value passed to this method will be set as the response's data property."))), _react.default.createElement(_Sections.Subsection, {
    title: "params",
    id: "params"
...
var _default = function _default(_ref) {
  var name = _ref.name;
  return _react.default.createElement(_BaseGuide.default, null, _react.default.createElement("h1", null, name), _react.default.createElement("p", null, "Curi side effects are essentially permament subscribers to your configuration object. They can be considered slightly more convenient than subscribers since you don't have to subscribe to your configuration object to set them up. However, you also cannot unsubscribe them."), _react.default.createElement("p", null, "Whenever a new response is generated, all of the side effect functions will be called. They will be given two arguments: the new response object and the action that was used to trigger the navigation (POP, PUSH, or REPLACE)."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "function logResponse(response) {\n  // call your logging API to record the response\n}"), _react.default.createElement(_Sections.Section, {
    title: "Adding Side Effects",
    id: "adding"
  }, _react.default.createElement("p", null, "You add side effect functions to your configuration object by adding a", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "sideEffects"), " array to the options object (the third agument) of ", _react.default.createElement(_PrismBlocks.InlineJS, null, "createConfig"), ". A side effect is an object with an ", _react.default.createElement(_PrismBlocks.InlineJS, null, "fn"), " property whose values is a subscriber function."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const config = createConfig(history, routes, {\n  sideEffects: [{ fn: logResponse }]\n});"), _react.default.createElement("p", null, "Side effects can also have an ", _react.default.createElement(_PrismBlocks.InlineJS, null, "after"), " property. By default, side effect functions will be called before any subscriber functions (the ones added with ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config.subscribe"), "). However, you might prefer for a side effect to be run after the subscribers. To do that, you just need to include ", _react.default.createElement(_PrismBlocks.InlineJS, null, "after: true"), " in your side effect object. If you do no provide this property, this will default to ", _react.default.createElement(_PrismBlocks.InlineJS, null, "false"), "."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BaseGuide.default, null, _react.default.createElement("h1", null, name), _react.default.createElement("p", null, "If you are bundling an application with a lot of routes, users of your application may be downloading a lot of unnecessary content just to render the initial page. Using code splitting, you can reduce the initial download size for your application by splitting code that is conditionally loaded into a separate bundle that is only downloaded when it is needed."), _react.default.createElement(_Messages.Note, null, "This guide assumes that you are using Webpack 2+ to bundle your application."), _react.default.createElement(_Sections.Section, {
  ...
  }, _react.default.createElement("p", null, "With code splitting, we don't want to have access to the component values when creating our routes because that means we have to download all of them before our application can render. We should remove our import calls so that that doesn't happen."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const routes = [\n  {\n    name: 'Home',\n    path: '',\n    body: () => Home\n  },\n  {\n    name: 'Contact',\n    path: 'contact',\n    body: () => Contact,\n    children: [\n      {\n        name: 'Contact Method',\n        path: ':method',\n        body: () => ContactMethod\n      }\n    ]\n  }\n];")), _react.default.createElement(_Sections.Section, {
    title: "Importing in preload",
    id: "preload"
  }, _react.default.createElement("p", null, "Now, ", _react.default.createElement(_PrismBlocks.InlineJS, null, "Home"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "Contact"), ", and", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "ContactMethod"), " are all undefined, so if we tried to render our application we would get errors. We need to actually import our components so that our body functions actually have something to return."), _react.default.createElement("p", null, "We will import our components using the preload property of routes. This function will only be called the first time that its route matches, so we don't have to worry about making extra requests to our server."), _react.default.createElement("p", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "preload"), " should be a function that returns a Promise. Here, we will call", _react.default.createElement(_PrismBlocks.InlineJS, null, "import()"), ", which conveniently returns a Promise."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
    ...
    id: "saving"
  }, _react.default.createElement("p", null, "That will load our components when their route matches, but we still don't have access to the component functions that we need in order to render. We will need to use a", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "then"), " call to our ", _react.default.createElement(_PrismBlocks.InlineJS, null, "import()"), " Promises in order to access the component functions."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
...
var _default = function _default(_ref) {
  var name = _ref.name;
  return _react.default.createElement(_BaseGuide.default, null, _react.default.createElement("h1", null, name), _react.default.createElement("p", null, "In the code splitting guide, we used the preload property of routes. Routes also have a load property. The biggest difference between the two is that load is called every time a route matches, whereas preload is only called the first time a route matches."), _react.default.createElement("p", null, "load is where you should perform any data loading for the route. We'll start a new application here, which is a basic recipe site. We want to have a route for a recipe list page as well as a route for specific recipes."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const routes = [\n  {\n    name: 'Recipe List',\n    path: 'recipes',\n    body: () => RecipeList\n  },\n  {\n    name: 'Recipe',\n    path: 'recipe/:id',\n    body: () => Recipe\n  }\n];"), _react.default.createElement("p", null, "Whenever the Recipe List route matches, we want to fetch a list of recipes from the server. When the Recipe route matches, we just want one specific recipe (using the id param from the path)."), _react.default.createElement("p", null, "The load function will be passed three arguments: a \"route\" object that contains ", _react.default.createElement(_PrismBlocks.InlineJS, null, "params"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "location"), " and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "name"), " properties, a modifiers object, and the object containing all of your Curi addons. The modifiers object has a few methods that you can call in order to modify the response object that will be generated. They are ", _react.default.createElement(_PrismBlocks.InlineJS, null, "fail"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "setStatus"), ",", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "setData"), " and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "redirect"), ". Each is explained in more detail in the", ' ', _react.default.createElement(_react2.Link, {
    to: "Guide",
    params: {
      slug: 'routes'
    },
...
var _default = function _default(_ref) {
  ...
  }, _react.default.createElement(_PrismBlocks.InlineJS, null, "@curi/react")), " package. To get started, there are only two components that you need to be aware of:", ' ', _react.default.createElement(_PrismBlocks.InlineComponent, null, "Navigator"), " and ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Link"), "."), _react.default.createElement(_Sections.Section, {
    title: "The Navigator",
    id: "navigator"
  }, _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "bash"
  ...
  }, "Navigator"), " component is responsible for re-rendering your application whenever the location changes. To do this, you pass it a Curi configuration object. When the Navigator is mounted, it will subscribe to your configuration object with a function that will trigger the Navigator to re-render whenever the location changes."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "import { Navigator } from '@curi/react';\n\nconst config = createConfig(history, routes);\nReactDOM.render((\n  <Navigator config={config} ... />\n), holder);"), _react.default.createElement("p", null, "In addition to the configuration object, the Navigator also takes a", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "render"), " prop. That is a function that returns the React elements that make up your application. The render function will receive two arguments:", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config"), ". Response is a response object and config is your configuration object (which can be useful to have access to, but you may also never have a reason to use it)."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const config = createConfig(history, routes);\n\nfunction render(response, config) {\n  // return a React element (or null)\n}\n\nReactDOM.render((\n  <Navigator config={config} render={render} />\n), holder);"), _react.default.createElement("p", null, "You ", _react.default.createElement("em", null, "can"), " define your render function inline, but typically it is easier to define the function in its own module and import it wherever you are rendering your Navigator. Inlining would also mean that the function gets recreated every time that the Navigator is re-rendered by its parent, which is not ideal."), _react.default.createElement("p", null, "The primary property of the response object that you will find useful is", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), ". The body property is the value returned by the matched route's body function. Since this is a React guide, this value should be a React component that will render the contents of the page for a specific route. For example, a Home component might render the contents of your homepage while an About component might render a page describing your application."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "import Home from './components/Home';\nimport About from './components/About';\n\nconst routes = [\n  {\n    name: 'Home',\n    path: '',\n    body: () => Home\n  },\n  {\n    name: 'About',\n    path: 'about',\n    body: () => About\n  }\n]"), _react.default.createElement("p", null, "When the body property of a response is ", _react.default.createElement(_PrismBlocks.InlineJS, null, "undefined"), ", that means that none of your routes matched the new location and you should render some sort of 404/page not found component. You may also want to add a catch all route (one whose path is ", _react.default.createElement(_PrismBlocks.InlineJS, null, "*"), ") so that you can expect to always have a body property on the response."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  ...
  }, "Navigator"), " API docs to learn more about the other props.")), _react.default.createElement(_Sections.Section, {
    title: "The Link",
    id: "link"
  }, _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "bash"
...
var _default = function _default(_ref) {
  ...
  return _react.default.createElement(_BaseGuide.default, null, _react.default.createElement("h1", null, name), _react.default.createElement("p", null, "The Curi router is somewhat similar to React Router versions 2 and 3, so migration is fairly easy. For instance, both use a centralized route configuration. Both configurations are made up of route objects (although with React Router some of these are disguised as JSX with ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Route"), " components). With both, routes can be nested, allowing child routes to build off of the paths from their parent routes."), _react.default.createElement("p", null, "Migration from React Router v2/3 to Curi should not require a complete reworking of your application, but there are some key differences."), _react.default.createElement("ol", null, _react.default.createElement("li", null, "The routing is handled entirely outside of React. With Curi, there are no ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Route"), " components."), _react.default.createElement("li", null, "With Curi, when a nested route matches, only that route renders. Any ancestor routes that also (partially) match are not rendered. This is different from React Router, where ancestors of the best matched route also render.")), _react.default.createElement(_Sections.Section, {
    ...
    href: "https://github.com/pillarjs/path-to-regexp"
  }, _react.default.createElement(_PrismBlocks.InlineJS, null, "path-to-regexp"), " repo"), ".\xA0"), _react.default.createElement("p", null, "First, we will just define the paths for our routes."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const routes = [\n  {\n    path: ''\n  },\n  {\n    path: 'inbox',\n    children: [\n      {\n        path: ':message'\n      }\n    ]\n  }\n];"), _react.default.createElement("p", null, "The biggest difference between the Curi paths and the React Router paths is that with Curi, you never include a forward slash at the beginning of the path. This means that while the root path for React Router is ", _react.default.createElement(_PrismBlocks.InlineJS, null, "'/'"), ", the root path for Curi is ", _react.default.createElement(_PrismBlocks.InlineJS, null, "''"), "."), _react.default.createElement("p", null, "Next, we should add our components to each route. We will ignore the ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "App"), " component that is used in the React Router routes. That is not route specific and will be rendered by our application (assuming we actually need it)."), _react.default.createElement("p", null, "With Curi routes, we have a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " property. This is a function that will be called whenever the route matches. Its return value will be added to the response object that Curi creates (more on that later). For this React application, we want our ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " functions to return the React component associated with each route."), _react.default.createElement("p", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " is a function and not a value because we might not always have access to the body value when the application loads. For example, with code splitting, we might not load the module until the user navigates to the route. Then, we would store the component in a cache and have the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " function return the component from the cache. You can read the", ' ', _react.default.createElement(_react2.Link, {
    to: "Guide",
    params: {
      slug: 'code-splitting'
    }
  }, "code splitting guide"), " for more information on how to do that."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const routes = [\n  {\n    path: '',\n    body: () => Home\n  },\n  {\n    path: 'inbox',\n    body: () => Inbox,\n    children: [\n      {\n        path: ':message',\n        body: () => Message\n      }\n    ]\n  }\n];"), _react.default.createElement("p", null, "We are close to replicating our React Router routes, we just have to implement the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "on___"), " methods for our\xA0", _react.default.createElement(_PrismBlocks.InlineJS, null, ":message"), " route. With Curi, routes have two possible loading function properties: ", _react.default.createElement(_PrismBlocks.InlineJS, null, "preload"), ' ', "and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), ". ", _react.default.createElement(_PrismBlocks.InlineJS, null, "preload"), " is useful for tasks that only need to be run once per route, like the code splitting mentioned above. ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), ", on the other hand, will be called every time that a route matches."), _react.default.createElement("p", null, "With React Router, ", _react.default.createElement(_PrismBlocks.InlineJS, null, "onEnter"), " is called when the route first matches, while ", _react.default.createElement(_PrismBlocks.InlineJS, null, "onChange"), " is called when the same route matches a new location (e.g. with new path parameters). ", _react.default.createElement(_PrismBlocks.InlineJS, null, "onEnter"), " and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "onChange"), " are nearly the same; the big difference between the two is that ", _react.default.createElement(_PrismBlocks.InlineJS, null, "onChange"), " will receive the previous props, which could be used to determine which props changed. When converting these to Curi, we will use ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " for both. This misses out on the ability to compare props in ", _react.default.createElement(_PrismBlocks.InlineJS, null, "onChange"), ", but (assuming you\u2019re using the comparison to determine whether to load new data) a cache should serve the same purpose."), _react.default.createElement("p", null, "There currently is no equivalent to ", _react.default.createElement(_PrismBlocks.InlineJS, null, "onLeave"), " with Curi. This is mostly because I haven\u2019t seen a compelling need for it. It certainly could be implemented, but so far I have not found a reason to use that. If you have something you need this functionality for, please open up an issue in the GitHub repo."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "const routes = [\n  {\n    path: '',\n    body: () => Home\n  },\n  {\n    path: 'inbox',\n    body: () => Inbox,\n    children: [\n      {\n        path: ':message',\n        body: () => Message,\n        load: (params, location, mods) => {...}\n      }\n    ]\n  }\n];"), _react.default.createElement("p", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "params"), " is an object of parsed path parameters, ", _react.default.createElement(_PrismBlocks.InlineJS, null, "location"), " is the current location object, and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "mods"), ' ', "is an object with functions to modify the response. For example, ", _react.default.createElement(_PrismBlocks.InlineJS, null, "mods.setData"), " allows you to attach loaded data to the response object. The ", _react.default.createElement(_react2.Link, {
    to: "Guide",
    params: {
      slug: 'routes'
    },
