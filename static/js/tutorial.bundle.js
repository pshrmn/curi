...
var _LoadFunction = _interopRequireDefault(__webpack_require__(72));
...
var _tutorials = _interopRequireDefault(__webpack_require__(14));
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 2: Setting up Curi"), _react.default.createElement("p", null, "Setup is never exciting, but a little bit of it is necessary."), _react.default.createElement("div", null, _react.default.createElement("p", null, "In this tutorial, we will be doing the following:"), _react.default.createElement("ul", null, _react.default.createElement("li", null, "Initializing our project and installing the packages (from NPM) that are necessary to get started."), _react.default.createElement("li", null, "Creating directories for our source and public files, as well as adding some empty files for future use."), _react.default.createElement("li", null, "Setting up a simple Express server to serve our website contents."), _react.default.createElement("li", null, "Setting up Babel/Webpack."))), _react.default.createElement(_Branch.TutorialBranch, {
    ...
    lang: "bash"
  }, "touch .babelrc.js webpack.config.js\nnpm install -D webpack webpack-dev-server @babel/core@next\n  @babel/preset-env@next babel-loader@next"), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 5: The Curi Configuration Object"), _react.default.createElement("p", null, "Curi uses a centralized configuration object to handle routing. Essentially, whenever the location changes (and when your application first loads), the configuration object will iterate over your routes to find one that matches the location. Then, it will use that route to generate a response object. This response contains a bunch of properties that are useful for rendering your application."), _react.default.createElement("div", null, _react.default.createElement("p", null, "In this tutorial, we will be doing the following:"), _react.default.createElement("ul", null, _react.default.createElement("li", null, "Creating a Curi configuration object using our routes and history object."), _react.default.createElement("li", null, "Learning about some of the properties of the configuration object and how Curi works."))), _react.default.createElement(_Branch.TutorialBranch, {
    ...
    id: "subscriber",
    type: "aside"
  }, _react.default.createElement("p", null, "In order to let your application know about location changes, Curi uses a subscriber model. Whenever a location change happens, Curi will create a new response and then emit this response to all of its subscribed methods. Using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config.subscribe"), ", we can give Curi a subscriber method to call when a new response has been created."), _react.default.createElement("p", null, "What does a subscriber function look like? It can take two arguments. The first will be the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " object generated for the new location. The second is the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "action"), " type from the navigation (", _react.default.createElement(_PrismBlocks.InlineJS, null, "'PUSH'"), ",", _react.default.createElement(_PrismBlocks.InlineJS, null, "'POP'"), ", and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "'REPLACE'"), ")."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "function responseLogger(response, action) {\n  console.log(\"RESPONSE:\", response);\n  console.log(\"ACTION\", action)\n}\nconfig.subscribe(responseLogger);")), _react.default.createElement(_Sections.Section, {
    title: "Review",
    id: "review"
  }, _react.default.createElement(_Branch.CompleteBranch, {
    name: "05-config-complete"
  })), _react.default.createElement(_Sections.Section, {
    title: "Next",
    id: "next"
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 6: React Pages"), _react.default.createElement("p", null, "Now that we have our configuration object ready to go, we can think about what our pages should look like. This tutorial will be rendering our website using React. If you prefer to use Vue, you should check out the", ' ', _react.default.createElement(_react2.Link, {
    ...
    lang: "bash"
  }, "npm install --save-dev @babel/preset-react@next"), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "// .babelrc.js\nmodule.exports = {\n  presets: [\n    ['@babel/env',{\n      modules: false\n    }],\n    '@babel/react'\n  ]\n};")), _react.default.createElement(_Sections.Section, {
    ...
    title: _react.default.createElement("span", null, "The ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Navigator"), " Component"),
    id: "Navigator"
  }, _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "import { Navigator } from '@curi/react';"), _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Navigator"), " is responsible for rendering the website whenever the location changes. It expects four props: ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "action"), ",", _react.default.createElement(_PrismBlocks.InlineJS, null, "config"), ", and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "render"), "."), _react.default.createElement("ol", null, _react.default.createElement("li", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " is a Curi response object."), _react.default.createElement("li", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "action"), " is the action type of the last navigation."), _react.default.createElement("li", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "config"), " is our Curi configuration object."), _react.default.createElement("li", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "render"), " is a function that will be called whenever a new response is emitted (and during the initial render) and returns the React element(s) that make up your website. It will receive three arguments: the new ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " object, the navigation's ", _react.default.createElement(_PrismBlocks.InlineJS, null, "action"), " and the Curi config object. The second two can be useful occasionally, but the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " is what we really need for rendering.")), _react.default.createElement("p", null, "In order to get the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "action"), " props, we need to subscribe to our Curi configuration object. That will allow us to always have the latest response and action values."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "jsx"
  }, "// index.js\nimport React from 'react';\nimport ReactDOM from 'react-dom';\nimport { Navigator } from '@curi/react';\n\n// ...\n\nconfig.subscribe((response, action) => {\n  ReactDOM.render((\n    <Navigator\n      response={response}\n      action={action}\n      config={config}\n      render={(response, action, config) => {\n        return null;\n      }}\n    />\n  ), document.getElementById('root'));\n});"), _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Navigator"), " also adds a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "curi"), " object to React's context. This object has ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), ", and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "action"), ' ', "properties. A number of the other components exported by ", _react.default.createElement(_PrismBlocks.InlineJS, null, "@curi/react"), ' ', "rely on these variables to render/function."), _react.default.createElement("p", null, "The above ", _react.default.createElement(_PrismBlocks.InlineJS, null, "render"), " function isn't very interesting because our application is rendering nothing (", _react.default.createElement(_PrismBlocks.InlineJS, null, "null"), "). We'll come back to that in a minute, but first we should learn about the other React component that we'll be using.")), _react.default.createElement(_Sections.Subsection, {
    ...
    id: "render-function"
  }, _react.default.createElement("p", null, "Let's go back to that ", _react.default.createElement(_PrismBlocks.InlineJS, null, "render"), " function that we pass to the", ' ', _react.default.createElement(_PrismBlocks.InlineComponent, null, "Navigator"), ". In the sample code above, we just returned", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "null"), ". Of course, for our website we want to return the actual elements that make up a page. How should we do this? Let's take a look at the properties of our response object."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "jsx"
  ...
  }, "Rendering with Responses"), " guide goes into more detail about each of the properties of a response object."), _react.default.createElement("p", null, "Your first thought about how to use a response to render might be to use ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.name"), ". You ", _react.default.createElement("em", null, "could"), " use a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "switch"), ' ', "to render different content based on the name."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "jsx"
  }, "function render(response) {\n  switch (response.name) {\n  case 'Home':\n    return <Home />;\n  case 'Contact':\n    return <Contact />;\n  }\n}"), _react.default.createElement("p", null, "Using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.name"), " grsow increasingly complex as you add more routes to your application. Instead, we are going to use one of the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "undefined"), " properties of the above response: ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), ". What is this property? The ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " property of a response is set by calling the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " function property of a matched route."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "jsx"
  }, "const routes = [\n  {\n    name: 'Home',\n    path: '',\n    body: () => 'You are here!'\n  }\n];\n// when the user visits the location { pathname: '/' }, the\n// response will look like this:\n{\n  name: 'Home',\n  status: 200,\n  body: 'You are here!',\n  // ...\n}"), _react.default.createElement("p", null, "Instead of returning a string, what if ", _react.default.createElement(_PrismBlocks.InlineJS, null, "route.body"), " returned React components? Then, our render function can use ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.body"), ' ', "to render our website. We'll expand on that later on, but for now, let's go ahead and define the components for each of our routes.")), _react.default.createElement(_Sections.Section, {
    ...
    name: "06-pages-react-complete"
  }), _react.default.createElement(_CodeSandboxDemo.default, {
    id: "github/pshrmn/curi-tutorial/tree/06-pages-react-complete"
  })), _react.default.createElement(_Sections.Section, {
    title: "Next",
    id: "next"
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 6: Vue Pages"), _react.default.createElement("p", null, "Now that we have our configuration object ready to go, we can think about what our pages should look like. This tutorial will be rendering our website using Vue. If you prefer to use React, you should check out the ", _react.default.createElement(_react2.Link, {
    ...
    title: "The Plugin",
    id: "plugin"
  }, _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineJS, null, "CuriPlugin"), " exported by ", _react.default.createElement(_PrismBlocks.InlineJS, null, "@curi/vue"), ", should be registered with Vue after the Curi configuration object has been created. When registering it (via ", _react.default.createElement(_PrismBlocks.InlineJS, null, "Vue.use"), "), you should pass a second argument: an object with a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "config"), " property whose value is your Curi configuration object."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "// index.js\nimport Vue from 'vue';\nimport CuriPlugin from '@curi/vue';\n\nconst config = createConfig(history, routes);\nVue.use(CuriPlugin, { config });"), _react.default.createElement("p", null, "This plugins does a couple things. First, it will make your Curi configuration object accessible to every component as", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "this.$curi"), ". Second, it will register Curi specific components. For this tutorial, the only component that we care about is ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "curi-link"), ".")), _react.default.createElement(_Sections.Subsection, {
    ...
    title: "The Response",
    id: "response"
  }, _react.default.createElement("p", null, "Being able to access the Curi configuration object is nice, but what we really need is to access the response objects that are emitted by Curi whenever the location changes. We can do this using the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "subscribe"), " method that we covered in the ", _react.default.createElement(_react2.Link, {
    to: "Tutorial",
    params: {
      name: '05-config'
    }
  }, "configuration object"), ' ', "tutorial."), _react.default.createElement("p", null, "First, we need to have a variable that will be used to store our Vue instance. Then, we will subscribe to the configuration object."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "// index.js\nlet vm;\nconfig.subscribe(response => {\n  // ...\n});"), _react.default.createElement("p", null, "Inside of the subscribe function, we have two branches. The first is when we don't have a Vue instance. When that is the case, we should create a new Vue instance. When we already have a Vue instance, we just need to update the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " object on the Vue instance."), _react.default.createElement("p", null, "When we are creating a Vue instance, the response object should be passed as a data property to the instance. We will have our Vue instance render an ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "app"), " component, which we will define next. The ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "app"), " is passed the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " object as a prop, which it will use to determine what to render."), _react.default.createElement("p", null, "When we are updating a Vue instance, we just need to set the new property on the Vue instance and Vue's reactivity will handle re-rendering the application."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "// index.js\nimport app from './components/App';\n\nlet vm;\nconfig.subscribe(response => {\n  if (!vm) {\n    vm = new Vue({\n      el: '#root',\n      data: {\n        response\n      },\n      // we'll get into the <app> soon\n      template: '<app :response=\"response\" />',\n      components: { app }\n    });\n  } else {\n    vm.response = response;\n  }\n});")), _react.default.createElement(_Sections.Section, {
    title: "The App",
    id: "app"
  }, _react.default.createElement("p", null, "At this point we have the ability to access our configuration object throughout our components and we are passing response objects to some ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "app"), " component that we haven't actually written yet. We should do that now."), _react.default.createElement("p", null, "Our ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "app"), " component will be responsible for rendering our website based on the response object. To start, let's add a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "components"), " directory to our ", _react.default.createElement(_PrismBlocks.InlineJS, null, "src"), " directory."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "bash"
  ...
  }, "Rendering with Responses"), " guide goes into more detail about each of the properties of a response object."), _react.default.createElement("p", null, "Your first thought about how to use a response to render might be to use ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.name"), ". You could use a template full of if/else attributes and render a different component based on the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "response.name"), ". In the same vein, you could add a computed property that returns a component for each possible ", _react.default.createElement(_PrismBlocks.InlineJS, null, "name"), ' ', "value and use ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "component :is"), " to render the computed property. Neither of those sounds very convenient, especially as your application gets more complex, although ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "component :is"), " is something we will want to use."), _react.default.createElement("p", null, "Instead, we are going to use one of the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "undefined"), " properties from the above response: ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), ". What is this property? The", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " property of a response is set by calling the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), ' ', "function property of a matched route."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "jsx"
  }, "const routes = [\n  {\n    name: 'Home',\n    path: '',\n    body: () => 'You are here!'\n  }\n];\n// when the user visits the location{ pathname: '/' }, the\n// response will look like this:\n{\n  name: 'Home',\n  status: 200,\n  body: 'You are here!',\n  ...\n}"), _react.default.createElement("p", null, "Now, instead of returning a string, what if our ", _react.default.createElement(_PrismBlocks.InlineJS, null, "route.body"), ' ', "properties were functions that returned Vue components? We can use", ' ', _react.default.createElement(_PrismBlocks.InlineComponent, null, "component :is"), " to dynamically set the component that Vue should render. Then, our render function can use ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.body"), " to render our website."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "html"
  }, "<!-- components/App.vue -->\n<template>\n  <component :is=\"response.body\" />\n</template>\n\n<script>\nexport default {\n  name: 'app',\n  props: ['response']\n};\n</script>"), _react.default.createElement("p", null, "Next, we should define the components for each of our routes.")), _react.default.createElement(_Sections.Section, {
    title: "The Route Components",
    id: "route-components"
    ...
    title: "Book Props",
    id: "book-props"
  }, _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "curi-link"), "s above allow us to navigate to our books, but we don't actually have any information about which book we are supposed to be seeing. It would really help if our ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Book"), " was able to access the parsed params so that it can render the information for the correct book."), _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineJS, null, "params"), " object is a property of our response object. That means that if we pass our response object as a prop to the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.body"), ", we can access these params in our route components."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "html"
  }, "<!-- components/App.vue -->\n<template>\n  <div>\n    <header>\n      <NavLinks />\n    </header>\n    <main>\n      <component\n        :is=\"response.body\"\n        :response=\"response\"\n      />\n    </main>\n  </div>\n</template>\n\n<script>\n  import NavLinks from './NavLinks';\n\n  export default {\n    name: 'app',\n    props: ['response'],\n    components: { NavLinks }\n  };\n</script>"), _react.default.createElement(_Messages.Note, null, "There are a number of ways that you can decide to pass props to your route components. The one thing to keep in mind is that ", _react.default.createElement("em", null, "all"), " of your route components will receive the same set of props. You can either be very specific and only pass the props that are necessary (e.g. ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "component :params=\"response.params\""), ") or you can just pass the entire response object (e.g. ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "component :response=\"response\""), ") so you don't have to worry about updating this every time one of your route components needs another prop from the response."), _react.default.createElement("p", null, "Next, we just need to update our ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Book"), " component so that it can access its", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "params"), " prop and figure out which book to render content for."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "html"
  }, "<!-- components/Book.vue -->\n<template>\n  <div class='book'>\n    Book {{response.params.id}}\n  </div>\n</template>\n\n<script>\n  export default {\n    props: ['response']\n  };\n</script>")), _react.default.createElement(_Sections.Section, {
    title: "Review",
    id: "review"
  }, _react.default.createElement("p", null, "After completing this tutorial, we now have a semi-functional website that renders basic content for each of our pages."), _react.default.createElement(_Branch.CompleteBranch, {
    name: "06-pages-vue-complete"
  }), _react.default.createElement(_CodeSandboxDemo.default, {
    id: "github/pshrmn/curi-tutorial/tree/06-pages-vue-complete"
  })), _react.default.createElement(_Sections.Section, {
    title: "Next",
    id: "next"
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 7: The Load Function"), _react.default.createElement("p", null, "In the previous tutorial, we wrote mocked book data in ", _react.default.createElement(_PrismBlocks.InlineJS, null, "books.js"), ' ', " to have some data to load, but it was just filler data. We just imported the data as an array, whereas in a \"real\" website, we would most likely make a request to our server which would return our data (possibly after running a database query)."), _react.default.createElement("div", null, _react.default.createElement("p", null, "In this tutorial, we will be doing the following:"), _react.default.createElement("ul", null, _react.default.createElement("li", null, "Writing a fake API to simulate data requests."), _react.default.createElement("li", null, "Adding ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " functions to our \"Book List\" and \"Book\" routes."))), _react.default.createElement(_Branch.TutorialBranches, {
    names: ['07-load-react', '07-load-vue']
  }), _react.default.createElement(_Sections.Section, {
    title: "Fake API",
    id: "api"
    ...
    title: "route.load",
    id: "load"
  }, _react.default.createElement("p", null, "Do you remember before when we said that Curi is an asynchronous router? Now is the time that we finally will see why."), _react.default.createElement("p", null, "Each route can have a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " property. This is a function that can perform data loading related to a route prior to emitting a response. We can use the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " function to modify the response or to update some other code like a global data store."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "{\n  name: 'Book List',\n  path: 'books',\n  load: function() {\n    // ...\n  }\n}"), _react.default.createElement(_Sections.Subsection, {
    title: "Load Arguments",
    id: "load-arguments",
    type: "aside"
  }, _react.default.createElement("p", null, "In order to load data/modify the response, ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " functions need to receive a few arguments."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "{\n    name: 'Book',\n    load: (route, mods, addons) => {\n      const { params, location, name } = route;\n      const { setData, redirect, fail, setStatus } = mods;\n      const { pathname, ...rest } = addons;   \n    }\n  }"), _react.default.createElement("p", null, "The first argument that will be passed to your load function is an object with properties related to the matched route. These are ", _react.default.createElement(_PrismBlocks.InlineJS, null, "params"), ", which is the object of path params parsed from the location's pathname,", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "location"), ", which is the location object used to match the route, and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "name"), ", which is the name of the matched route."), _react.default.createElement("p", null, "The second argument that will be passed to your load function is an object whose properties are functions that you can use to modify the response object. These functions are ", _react.default.createElement(_PrismBlocks.InlineJS, null, "setData"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "redirect"), ", ", _react.default.createElement(_PrismBlocks.InlineJS, null, "setStatus"), ", and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "fail"), ". The", ' ', _react.default.createElement(_react2.Link, {
    to: "Guide",
    params: {
      slug: 'routes'
    },
  ...
  }, "All About Routes"), " guide goes into detail about all four of those. For this tutorial, we will only be using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "setData"), "."), _react.default.createElement("p", null, "The third, and final, argument that will be passed to your load function is an object containing all of the Curi addons that are registered with your Curi configuration object. This includes the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "pathname"), " addon, which you may find useful for generating pathnames in your ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " (particularly if you plan to use the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "redirect"), " function mentioned above).")), _react.default.createElement(_Sections.Subsection, {
    title: "Load Return Value",
    id: "load-return",
    type: "aside"
  }, _react.default.createElement("p", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " functions are expected to return a Promise. Curi uses", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "Promise.all"), " to wait for your ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " function to resolve before it emits a response. Technically speaking, your ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " function does not have to return a Promise, but it is recommended."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "{\n  load: (route, mods, addons) => {\n    return fetch(`/api/book/${route.params.id}`)\n      .then(resp => {...});\n  }\n}")), _react.default.createElement("p", null, "We have two routes to add load functions to: \"Book List\" and \"Book\". Let's start by having each one call their respective API functions that we defined above."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "// routes.js\nimport { fetchAllBooks, fetchBook } from './api/books';\nconst routes = [\n  // ...,\n  {\n    name: 'Book List',\n    path: 'books',\n    body: () => BookList,\n    load: (route, response, addons) => {\n      return fetchAllBooks();\n    },\n    children: [\n      {\n        name: 'Book',\n        path: ':id',\n        body: () => Book,\n        params: { id: n => parseInt(n, 10) },\n        load: (route, response, addons) => {\n          return fetchBook(route.params.id);\n        }\n      }\n    ]\n  },\n  // ...\n];"), _react.default.createElement(_Messages.Note, null, "In the above \"Book\" route, we introduce the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "route.params"), ' ', "property. This is an object whose keys are path param names and whose values are functions that will parse the param string to return a new value. For example, the above function takes the input string and returns that string parsed as an integer."), _react.default.createElement("p", null, "If the only thing that our ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " functions do is return a Promise, they aren't particularly useful. Instead, we need to use the results of our fetch functions to call the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "setData"), " function that is provided by the second argument to our load function. ", _react.default.createElement(_PrismBlocks.InlineJS, null, "setData"), " takes an object and will add that object to the response object as its ", _react.default.createElement(_PrismBlocks.InlineJS, null, "data"), " property. Let's add ", _react.default.createElement(_PrismBlocks.InlineJS, null, "then"), " callback functions to our fetches to do this."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "// routes.js\nimport { fetchAllBooks, fetchBook } from './api/books';\nconst routes = [\n  // ...,\n  {\n    name: 'Book List',\n    path: 'books',\n    body: () => BookList,\n    load: (route, response, addons) => {\n      return fetchAllBooks()\n        .then(books => {\n          response.setData({ books });\n        });\n    },\n    children: [\n      {\n        name: 'Book',\n        path: ':id',\n        body: () => Book,\n        params: { id: n => parseInt(n, 10) },\n        load: (route, response, addons) => {\n          return fetchBook(route.params.id)\n            .then(\n              book => {\n                response.setData({ book });\n              },\n              err => {\n                console.error(err);\n              }\n            );\n        }\n      }\n    ]\n  },\n  // ...\n];"), _react.default.createElement(_Messages.Note, null, "You are responsible for catching any errors within your", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " function. If you do not, they can be swallowed and cause unexpected errors in your website."), _react.default.createElement("p", null, "Now, when a user visits ", _react.default.createElement(_PrismBlocks.InlineJS, null, "/books"), ", the response generated by Curi will look like this:"), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 8: Rendering Data with React"), _react.default.createElement("p", null, "Now that our responses have ", _react.default.createElement(_PrismBlocks.InlineJS, null, "data"), ", we should update our ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "BookList"), " and ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Book"), " components to use that. Accessing the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "data"), " is really easy because it is a property of our ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " object."), _react.default.createElement("div", null, _react.default.createElement("p", null, "In this tutorial, we will be doing the following:"), _react.default.createElement("ul", null, _react.default.createElement("li", null, "Updating our ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "BookList"), " and ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Book"), ' ', "components to render using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.data"), "."))), _react.default.createElement(_Branch.TutorialBranch, {
    ...
    lang: "jsx"
  }, "// components/BookList.js\nconst BookList = ({ response }) => (\n  <div className='book-list'>\n    <h1>Available Books</h1>\n    <div className='books'>\n      { response.data.books.map(b => (\n        <div key={b.id} className='book-item'>\n          <Link to='Book' params={{ id: b.id }}>\n            {b.title}\n          </Link>\n        </div>\n      )) }\n    </div>\n  </div>\n);"), _react.default.createElement(_Messages.Note, null, "If our ", _react.default.createElement(_PrismBlocks.InlineJS, null, "render"), " function (passed to the ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Navigator"), ") had just passed the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "params"), " instead of the whole", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), ", we would have to modify that function to also pass along the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "data"), ". Since we pass the entire", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), ", we do not have to worry about updating that function.")), _react.default.createElement(_Sections.Section, {
    ...
    name: "08-render-data-react-complete"
  }), _react.default.createElement(_CodeSandboxDemo.default, {
    id: "github/pshrmn/curi-tutorial/tree/08-render-data-react-complete"
  })), _react.default.createElement(_Sections.Section, {
    title: "Next",
    id: "next"
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 8: Rendering Data with Vue"), _react.default.createElement("p", null, "Now that our responses have ", _react.default.createElement(_PrismBlocks.InlineJS, null, "data"), ", we should update our ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "BookList"), " and ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Book"), " components to use that. Accessing the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "data"), " is really easy because it is a property of our ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response"), " object."), _react.default.createElement("div", null, _react.default.createElement("p", null, "In this tutorial, we will be doing the following:"), _react.default.createElement("ul", null, _react.default.createElement("li", null, "Updating our ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "BookList"), " and ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "Book"), ' ', "components to render using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.data"), "."))), _react.default.createElement(_Branch.TutorialBranch, {
    ...
    name: "08-render-data-vue-complete"
  }), _react.default.createElement(_CodeSandboxDemo.default, {
    id: "github/pshrmn/curi-tutorial/tree/08-render-data-vue-complete"
  })), _react.default.createElement(_Sections.Section, {
    title: "Next",
    id: "next"
  }, _react.default.createElement("p", null, "Our book component still isn't complete. We are building a book store after all, so we should really provide the user a way to actually \"buy\" a book. In", ' ', _react.default.createElement(_react2.Link, {
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 9: Forms & Programmatic Navigation"), _react.default.createElement("p", null, "In this tutorial, we are going to be using another property of our Curi configuration object: ", _react.default.createElement(_PrismBlocks.InlineJS, null, "history"), ". This property is our Hickory history instance. We will use it to perform navigation between pages in our website."), _react.default.createElement("div", null, _react.default.createElement("p", null, "In this tutorial, we will be doing the following:"), _react.default.createElement("ul", null, _react.default.createElement("li", null, "Creating another fake API, this time for getting/setting items in our shopping cart."), _react.default.createElement("li", null, "Adding the ability to add books to the shopping cart from the \"Book\" page."), _react.default.createElement("li", null, "Displaying books in the shopping cart from the \"Checkout\" page and allowing users to \"purchase\" their selected books."), _react.default.createElement("li", null, "Performing programmatic navigation to automatically navigate to another location."))), _react.default.createElement(_Branch.TutorialBranch, {
    ...
    name: "09-nav-react-complete"
  }), _react.default.createElement(_CodeSandboxDemo.default, {
    id: "github/pshrmn/curi-tutorial/tree/09-nav-react-complete"
...
var _default = function _default() {
  return _react.default.createElement(_BaseTutorial.default, null, _react.default.createElement("h1", null, "Part 9: Forms & Programmatic Navigation"), _react.default.createElement("p", null, "In this tutorial, we are going to be using another property of our Curi configuration object: ", _react.default.createElement(_PrismBlocks.InlineJS, null, "history"), ". This property is the Hickory history instance. We will use it to perform navigation between pages in our website."), _react.default.createElement("div", null, _react.default.createElement("p", null, "In this tutorial, we will be doing the following:"), _react.default.createElement("ul", null, _react.default.createElement("li", null, "Creating another fake API, this time for getting/setting items in our shopping cart."), _react.default.createElement("li", null, "Adding the ability to add books to the shopping cart from the \"Book\" page."), _react.default.createElement("li", null, "Displaying books in the shopping cart from the \"Checkout\" page and allowing users to \"purchase\" their selected books."), _react.default.createElement("li", null, "Performing programmatic navigation to automatically navigate to another location."))), _react.default.createElement(_Branch.TutorialBranch, {
    ...
    href: "https://github.com/pshrmn/hickory/blob/master/docs/api/Browser.md#methods"
  }, "Hickory documentation"), ". For this tutorial, we will be using", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "push"), "."), _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineJS, null, "CuriPlugin"), " makes our configuration object available to all of our components as ", _react.default.createElement(_PrismBlocks.InlineJS, null, "this.$curi"), ". That means that we can call ", _react.default.createElement(_PrismBlocks.InlineJS, null, "this.$curi.history.push"), " (a bit of a mouthful) to automatically redirect to another page."), _react.default.createElement("p", null, "We can also access all of our Curi ", _react.default.createElement(_PrismBlocks.InlineJS, null, "addons"), " from our configuration object, so we will use ", _react.default.createElement(_PrismBlocks.InlineJS, null, "curi.addons.pathname"), " to generate the pathname for the location that we wan to redirect to."), _react.default.createElement("p", null, "When the user clicks either of the buttons, we will want to use the", ' ', _react.default.createElement(_PrismBlocks.InlineJS, null, "updateCart"), " API method to add the book to the shopping cart. The ", _react.default.createElement(_PrismBlocks.InlineComponent, null, "AddToCart"), " component doesn't inherently know which book it is for, so we will need to pass it the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "id"), " of the book as a prop when we render it."), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "html"
    ...
    name: "09-nav-vue-complete"
  }), _react.default.createElement(_CodeSandboxDemo.default, {
    id: "github/pshrmn/curi-tutorial/tree/09-nav-vue-complete"
  }), _react.default.createElement(_Messages.Note, null, "The embedded sandbox will not work if your browser is blocking third-party data. If this is the case for you, you ", _react.default.createElement("em", null, "could"), " disable this through your browser's settings, but a better solution is to click the \"Edit on CodeSandbox\" button to view the sandbox there.")), _react.default.createElement(_Sections.Section, {
    title: "Next",
    id: "next"
  }, _react.default.createElement("p", null, "With that, we have considered pretty much everything you need to know to get started building your website with Curi. We have one last part,", ' ', _react.default.createElement(_react2.Link, {
...
var _default = function _default() {
  ...
  }, "@pshrmn"), ". Any feedback is appreciated!"), _react.default.createElement("p", null, "Now, you may be wondering what else to do. My first suggestion would be to build your own website! The tutorial went through everything you need to know to get started building a site with Curi, so why not build your own?"), _react.default.createElement("p", null, "If you are looking to learn/build more, you can also try some of the suggestions listed below."), _react.default.createElement("ol", null, _react.default.createElement("li", null, "The current home page is quite boring. You could add a \"featured\" book to it using the \"Home\" route's ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), " function to attach a random book to the response."), _react.default.createElement("li", null, "Similar to the previous suggestion, the contact page could use some work as well. Perhaps you could add some child routes for different methods of contact."), _react.default.createElement("li", null, "You can try using a Curi ", _react.default.createElement(_react2.Link, {
    to: "Guide",
    params: {
      slug: 'side-effects'
    }
  ...
  }, "code splitting guide"), ' ', "and break up the bundle using ", _react.default.createElement(_PrismBlocks.InlineJS, null, "route.preload"), "."), _react.default.createElement("li", null, "While we used ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.data"), " to pass data to our components, you might prefer a global store like Redux or Vuex. You could rewrite the application to use these, ", _react.default.createElement(_PrismBlocks.InlineJS, null, "response.data"), " is a convenience, not a requirement. You can even continue to use ", _react.default.createElement(_PrismBlocks.InlineJS, null, "route.load"), " with a global store. Instead of calling ", _react.default.createElement(_PrismBlocks.InlineJS, null, "setData"), ", you could just dispatch the data to your store. You can check out the ", _react.default.createElement(_react2.Link, {
    to: "Example",
    params: {
      slug: 'redux'
    }
  }, "Redux example"), ' ', "to see how this might be implemented."), _react.default.createElement("li", null, "You can explore the other response methods available in ", _react.default.createElement(_PrismBlocks.InlineJS, null, "route.load"), ". For example, you could use the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "redirect"), " function to automatically redirect when the user attempt to navigate to a \"Book\" page that doesn't exist (e.g. there is no book whose ", _react.default.createElement(_PrismBlocks.InlineJS, null, "id"), " equals ", _react.default.createElement(_PrismBlocks.InlineJS, null, "params.id"), ")."), _react.default.createElement("li", null, "We only had ten books in our data, but what if there were hundreds? You could implement pagination on the \"Book List\" page. Query params could be included in the location to only display certain books. If you're feeling adventurous, you could pass a", ' ', _react.default.createElement("a", {
