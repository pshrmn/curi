...
var byName = examples.reduce(function (acc, curr) {
  acc[curr.slug] = curr;
  return acc;
}, {});
...
var _versions = _interopRequireDefault(__webpack_require__(45));
...
var _sideEffectTitle = _interopRequireDefault(__webpack_require__(32));

var _sideEffectScroll = _interopRequireDefault(__webpack_require__(33));

var _addonActive = _interopRequireDefault(__webpack_require__(34));

var _routes = _interopRequireDefault(__webpack_require__(35));

var _render = _interopRequireDefault(__webpack_require__(48));
...
config.subscribe(function (response, action) {
  _reactDom.default.hydrate(_react.default.createElement(_react2.Navigator, {
    response: response,
    action: action,
    config: config,
...
var _Home = _interopRequireDefault(__webpack_require__(36));

var _PackageList = _interopRequireDefault(__webpack_require__(44));

var _ExampleList = _interopRequireDefault(__webpack_require__(46));
...
function handleImport(name) {
  return {
    loaded: function loaded(module) {
      loadedModules[name] = module.default;
    },
    caught: function caught(err) {
      console.error('Failed to load module for:', name, err);

      loadedModules[name] = function () {
...
var _default = [{
  ...
  preload: function preload() {
    var _handleImport = handleImport('Tutorial'),
        loaded = _handleImport.loaded,
        caught = _handleImport.caught;

    return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 51)).then(loaded).catch(caught);
  },
  body: function body() {
  ...
  path: 'guides/:slug/',
  preload: function preload() {
    var _handleImport2 = handleImport('Guide'),
        loaded = _handleImport2.loaded,
        caught = _handleImport2.caught;

    return __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 52)).then(loaded).catch(caught);
  },
  ...
  children: [{
    ...
    path: '@curi/:package/',
    preload: function preload() {
      var _handleImport3 = handleImport('Package'),
          loaded = _handleImport3.loaded,
          caught = _handleImport3.caught;

      return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 53)).then(loaded).catch(caught);
    },
  ...
  children: [{
    ...
    path: ':slug/',
    preload: function preload() {
      var _handleImport4 = handleImport('Example'),
          loaded = _handleImport4.loaded,
          caught = _handleImport4.caught;

      return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 54)).then(loaded).catch(caught);
    },
...
var _Banner = _interopRequireDefault(__webpack_require__(39));
...
var _default = function _default() {
  return _react.default.createElement("div", null, _react.default.createElement(_Banner.default, null), _react.default.createElement("div", {
  ...
  }, _react.default.createElement("p", null, "The ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " function of routes can be used to attach a ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), ' ', "property to response objects. Generally, this attached value would be a function or component (this would vary based on how your framework renders), but it can be anything you want it to be.")), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
    ...
    className: "description"
  }, _react.default.createElement("p", null, _react.default.createElement(_PrismBlocks.InlineJS, null, "data"), " can contain values that you load using a route's ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), ' ', "function. The response won't be be generated until after the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "load"), ' ', "function has resolved, so if you use this property, you don't have to render a bunch of loading spinners or empty content while waiting for the data to be loaded.")), _react.default.createElement(_PrismBlocks.PrismBlock, {
    lang: "javascript"
  }, "{\n  ...,\n  data: {\n    username: 'curi',\n    id: '234235',\n    color: '#222233'\n  }\n}"))), _react.default.createElement("div", {
    className: "feature"
    ...
    className: "description"
  }, _react.default.createElement("p", null, "Use the ", _react.default.createElement(_PrismBlocks.InlineJS, null, "preload"), " and ", _react.default.createElement(_PrismBlocks.InlineJS, null, "body"), " properties to add code splitting at your routes."), _react.default.createElement("p", null, _react.default.createElement("strong", null, "Note:"), " This relies on a bundler like Webpack."), _react.default.createElement("p", null, "You can learn more about this with the", ' ', _react.default.createElement(_react2.Link, {
    to: "Guide",
    params: {
      slug: 'code-splitting'
    }
...
var _ReactBanner = _interopRequireDefault(__webpack_require__(40));

var _VueBanner = _interopRequireDefault(__webpack_require__(41));

var _GenericBanner = _interopRequireDefault(__webpack_require__(42));

var _SvelteBanner = _interopRequireDefault(__webpack_require__(43));
...
var _ExampleTiles = _interopRequireDefault(__webpack_require__(47));
...
var _default = function _default() {
  ...
  }, "on GitHub"), "."), _react.default.createElement(_ExampleTiles.default, null), _react.default.createElement("p", null, "You can see the source code for all of the examples on", ' ', _react.default.createElement("a", {
    href: "https://github.com/pshrmn/curi/tree/master/examples"
  }, "GitHub"), "."));
};
...
var _Header = _interopRequireDefault(__webpack_require__(49));
...
var _Nav = _interopRequireDefault(__webpack_require__(50));
