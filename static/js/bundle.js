...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "js/" + ({"0":"example","1":"package","2":"guide","3":"tutorial"}[chunkId]||chunkId) + ".bundle.js";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_broadcast__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_warning__ = __webpack_require__(28);
...
var _PrismCode = _interopRequireDefault(__webpack_require__(34));
...
exports.default = exports.byName = exports.groupedTutorials = void 0;
var tutorials = [{
  title: "React Basics",
  slug: "react-basics",
  type: "Basic",
  description: "Learn the basics of setting up a single-page application using Curi and React"
}, {
  title: "Vue Basics",
  slug: "vue-basics",
  type: "Basic",
  description: "Learn the basics of setting up a single-page application using Curi and Vue"
}];
var groupedTutorials = tutorials.reduce(function (acc, curr) {
  if (!acc[curr.type]) {
    acc[curr.type] = [curr];
  } else {
...
exports.groupedTutorials = groupedTutorials;
...
var _browser = _interopRequireDefault(__webpack_require__(20));

var _core = _interopRequireDefault(__webpack_require__(24));

var _react2 = __webpack_require__(1);

var _sideEffectTitle = _interopRequireDefault(__webpack_require__(29));

var _sideEffectScroll = _interopRequireDefault(__webpack_require__(30));

var _addonActive = _interopRequireDefault(__webpack_require__(31));
...
var _TutorialBase = _interopRequireDefault(__webpack_require__(49));

var _tutorials = __webpack_require__(11);
...
var _default = [{
  ...
  children: [{
    ...
    match: {
      initial: function initial() {
        return __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 54)).then(function (module) {
      ...
      response: function response(_ref3) {
        ...
        var tutorial = _tutorials.byName[route.params.slug];

        if (tutorial) {
          set.title("Tutorial ".concat(tutorial.title));
        }
      }
    }
  }]
  ...
  children: [{
    ...
    match: {
      initial: function initial() {
        return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 55)).then(function (module) {
          return module.default;
...
var _default = function _default() {
  return _react.default.createElement("div", null, _react.default.createElement(_Banner.default, null), _react.default.createElement("div", {
    ...
    className: "feature"
  }, _react.default.createElement("h3", null, "Frameworks"), _react.default.createElement("p", null, "Curi provides packages to render with popular frameworks."), _react.default.createElement("ul", null, _react.default.createElement("li", null, _react.default.createElement(_react2.Link, {
    to: "Package",
    params: {
      package: "react"
    }
    ...
    className: "feature"
  }, _react.default.createElement("h3", null, "Sync or Async"), _react.default.createElement("p", null, "Curi does synchronous route matching by default, but can easily", " ", _react.default.createElement(_react2.Link, {
    to: "Guide",
    params: {
      slug: "sync-or-async"
    }
  }, "switch to asynchronous matching"), ", which enables code-splitting and preloading data.")), _react.default.createElement("div", {
    className: "feature"
  ...
  }, "Response"), " ", "objects provide data about the route that matches a location and are used to render your application.")), _react.default.createElement("div", {
    className: "feature"
  ...
  }, _react.default.createElement(_PrismBlocks.InlineJS, null, "hickory")), " ", "package to power navigation anywhere you can run JavaScript.")), _react.default.createElement("div", {
    className: "feature"
  }, _react.default.createElement("h3", null, "Server Side Rendering"), _react.default.createElement("p", null, "Server side rendering with Curi is as easy as client side rendering. The main difference is that you will swap the browser history with an in-memory history."))));
};
...
var _Sections = __webpack_require__(5);
...
var _TutorialTiles = _interopRequireDefault(__webpack_require__(50));
...
var _default = function _default() {
  return _react.default.createElement("div", {
    ...
    className: "content"
  }, _react.default.createElement("h1", null, "Curi Tutorials"), _react.default.createElement(_TutorialTiles.default, null)));
};
...
var Category = function Category(_ref) {
  ...
  return _react.default.createElement("ul", {
    ...
    return _react.default.createElement("li", {
      key: "".concat(tutorial.category, "/").concat(tutorial.slug),
      className: "tile"
    }, _react.default.createElement(_react2.Link, {
      to: "Tutorial",
      params: {
    ...
    }, _react.default.createElement("h2", null, tutorial.title), _react.default.createElement("p", {
      className: "description"
...
var _default = function _default() {
  var categories = Object.keys(_tutorials.groupedTutorials);
  return _react.default.createElement("div", null, categories.map(function (key) {
    return _react.default.createElement(_Sections.Section, {
      ...
      name: key,
      tutorials: _tutorials.groupedTutorials[key]
    }));
  }));
};
...
var _default = function _default() {
  ...
  }, "Tutorials")), _react.default.createElement("li", null, _react.default.createElement(_react2.Link, {
    to: "Guides",
    active: {
      merge: _styleActive.default,
      partial: true
