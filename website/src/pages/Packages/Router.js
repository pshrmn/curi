        ...
        <APIBlock>
          <Section title="curi" id="curi">
            <SideBySide>
              <Explanation>
                <p>
                  The <IJS>curi</IJS> export is a function to create a router.
                  It has two required arguments: a <IJS>history</IJS> object and
                  a <IJS>routes</IJS> array, and an optional third argument: an{" "}
                    ...
                    <SideBySide>
                      <Explanation>
                        <p>
                          ...
                          >
                            route interactions
                          </Link>. These are functions for interacting with
                          routes based on their <IJS>name</IJS>.
                        </p>
                        <p>
                    ...
                    <SideBySide>
                      <Explanation>
                        <p>
                          ...
                          (default is <IJS>true</IJS>), response objects with
                          the <IJS>redirectTo</IJS> property{" "}
                          <strong>will not be emitted</strong> to observers.
                          This can be useful for avoiding an extra render, but
                ...
                <SideBySide>
                  <Explanation>
                    <p>
                      ...
                      programmatically. It takes a <IJS>details</IJS> object
                      with the details of where you want to navigate to as well
                      as the <IJS>method</IJS> of navigation.
                    </p>
                    <table>
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>params</td>
                          <td>
                            An object of any route params for the named route
                            (and any of its ancestors that require params).
                          </td>
                        </tr>
                        <tr>
                          <td>hash</td>
                          <td>
                            The hash string of the location to navigate to.
                          </td>
                        </tr>
                        <tr>
                          <td>query</td>
                          <td>
                            The query value of the location to navigate to.
                          </td>
                        </tr>
                        <tr>
                          <td>state</td>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            replaces the current location. <IJS>"ANCHOR"</IJS>{" "}
                            is the default method and acts like clicking a link.
                            This behavior is a mix of <IJS>"PUSH"</IJS> and{" "}
                        ...
                        <tr>
                          <td>cancelled</td>
                          <td>
                            A function to call if the navigation is superseded
                ...
                <SideBySide>
                  <Explanation>
                    <p>
                      ...
                      function. If a response already exists, the function will
                      be called immediately. Otherwise, the function will be
                      called once a new response is created. The{" "}
                      <IJS>{`\{ initial: false \}`}</IJS> option can be used to
                      prevent an immediate call even if a response already
                      exists.
                    </p>
                    <table>
                      <thead>
              ...
              <Subsection tag="h5" title="refresh()" id="refresh-property">
                <SideBySide>
                  <Explanation>
                    ...
                    <p>
                      The function can be called without any arguments and it
                      will emit a response using the existing routes.
                    </p>
                  </Explanation>
                  <CodeBlock>
                    {`const oldRoutes = [...];
            ...
            <SideBySide>
              <Explanation>
                <p>
                  ...
                  new function. The first time the returned function is called,
                  it will call the function passed to <IJS>once()</IJS>. Every
                ...
                <Note>
                  ...
                  variables that will change for a route (i.e. loading data
            ...
            <SideBySide>
              <Explanation>
                <p>
                  ...
                  interaction for you to generate URL pathnames for routes. If
                  you need to access this same ability outside of a router, you
                  can import the <IJS>pathname</IJS> route interaction.
                </p>
              </Explanation>
              <CodeBlock>
              ...
              <SideBySide>
                <Explanation>
                  ...
                  <Warning>
                    ...
                    <IJS>path-to-regexp</IJS> to generate pathnames from a
                    route's name, which it can only do from strings paths.
                  </Warning>
                </Explanation>
                <CodeBlock>
                  {`[
...
// { name: 'Home', path: '/' }`}
            ...
            <Subsection title="route.resolve" id="resolve">
              <SideBySide>
                <Explanation>
                  <p>
                    The <IJS>resolve</IJS> object groups async functions that
                    will be called when the route matches.
                  </p>
                  <p>
                    A route with any <IJS>resolve</IJS> functions is
                    asynchronous, while one with no <IJS>resolve</IJS> functions
                    is synchronous. You can read more about this is the{" "}
                  ...
                  <p>
                    <IJS>resolve</IJS> functions will be passed an object with
                    the matched route properties: <IJS>name</IJS>,{" "}
                    <IJS>params</IJS>, <IJS>partials</IJS>, and{" "}
                    <IJS>location</IJS>.
                  </p>
                  <Note>
                    You should not perform side effects (e.g. passing the loaded
                    data to a Redux store) in <IJS>resolve</IJS> functions
                    because it is possible that navigating to the route might be
    ...
    data: () => fetch('/api/about')
            ...
            <Subsection title="route.response()" id="response">
              <SideBySide>
                <Explanation>
                  <p>
                    A function for modifying the response object. This returns
                    an object whose properties will be merged with the matched
                    route properties to create the "final" response.
                  </p>
                  <p>
...
// response = { body: Home, ... }`}
                ...
                <li>
                  <SideBySide>
                    <Explanation>
                      <p>
                        <IJS>status</IJS> - A number. This is useful for
                        redirects or locations caught by your catch-all route
                        while using server-side rendering. The default status
                        value is <IJS>200</IJS>.
                      </p>
                    </Explanation>
                    <CodeBlock>
                      {`{
...
// response = { title: "User 2", ... }`}
                ...
                <li>
                  <SideBySide>
                    <Explanation>
                      <p>
                        <IJS>redirectTo</IJS> - An object with the{" "}
                        <IJS>name</IJS> of the route to redirect to,{" "}
                        <IJS>params</IJS> (if required), and optional{" "}
                        <IJS>hash</IJS>, <IJS>query</IJS>, and <IJS>state</IJS>{" "}
                        properties.
                      </p>
                      <p>
...
// response = { redirectTo: { pathname: "/p/1", ... } }`}
              ...
              <SideBySide>
                <Explanation>
                  <p>
                    This function is passed an object with a number of
              ...
              <ul>
                <Subsection tag="li" title="match" id="response-match">
                  <SideBySide>
                    <Explanation>
                      <p>
                        An object with the matched route properties of a
                        response.
                      </p>
                      <table>
                        <thead>
                ...
                <Subsection tag="li" title="resolved" id="response-resolved">
                  <SideBySide>
                    <Explanation>
                      <p>
                        <IJS>resolved</IJS> is an object with the values
                        resolved by the <IJS>resolve</IJS> functions.
                      </p>
                      <p>
      ...
      data: resolved.data
                ...
                <Subsection tag="li" title="error" id="response-error">
                  <SideBySide>
                    <Explanation>
                      <p>
                        <IJS>error</IJS> is an error thrown by one of the
                        route's <IJS>resolve</IJS> functions.
                      </p>
                    </Explanation>
                    <CodeBlock>
      ...
      data: resolved.data
            ...
            <Subsection title="children" id="children">
              <SideBySide>
                <Explanation>
                  <p>
                    An optional array of route objects for creating nested
                    routes. Any child routes will be matched relative to their
                    parent route's <IJS>path</IJS>. This means that if a parent
                    route's <IJS>path</IJS> string is <IJS>'one'</IJS> and a
                    child route's <IJS>path</IJS> string is <IJS>'two'</IJS>,
                    the child will match when the pathname is{" "}
                    <IJS>'one/two'</IJS>.
                  </p>
                </Explanation>
                <CodeBlock>
            ...
            <Subsection title="params" id="params">
              <SideBySide>
                <Explanation>
                  ...
                  <p>
                    Properties of the <IJS>route.params</IJS> object are the
                    names of params to be parsed. The paired value should be a
                    function that takes a string (the value from the{" "}
                    <IJS>pathname</IJS>) and returns a new value (transformed
              ...
              <SideBySide>
                <Explanation>
                  <p>
                    ...
                    used by <IJS>path-to-regexp</IJS>, you can provide them with
                    a <IJS>pathOptions</IJS> object.
                  </p>
                  <Note>
