            ...
            <SideBySide>
              <Explanation>
                <p>
                  ...
                  the `route` option, which will add an <IJS>active()</IJS>{" "}
                  function to the router's route interactions.
                </p>
                <p>
                  The interaction returns a boolean: <IJS>true</IJS> when a
                  route is "active" (it matches the response's{" "}
                  <IJS>location</IJS>) and <IJS>false</IJS> when it does not.
                </p>
              </Explanation>
              <CodeBlock>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>partial</td>
                        <td>
                          when <IJS>true</IJS>, ancestor routes can be
