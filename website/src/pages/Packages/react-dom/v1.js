      ...
      {navigating ? <Spinner /> : null}
              ...
              <HashSection tag="h4" title="anchor" id="Link-anchor">
                <p>
                  ...
                  your own component to be rendered instead. This can be useful
                  for using styled components to navigate.
                </p>
                <Warning>
      ...
      {/* ... */}
            ...
            <HashSection tag="h3" title="Props" id="focus-props">
              <HashSection tag="h4" title="children()" id="focus-children">
                ...
                <p>
                  If you need to pass this through class/functional components,
                  you should use either <IJS>React.forwardRef()</IJS> or pass it
                  as a prop with a name other than <IJS>ref</IJS> (like{" "}
                  <IJS>innerRef</IJS>).
                </p>
  ...
  {ref => <SomeComponent innerRef={ref} />}
              ...
              >
                <p>
                  ...
                  <IJS>{`preventScroll=\{true\}`}</IJS> to the <Cmp>Focus</Cmp>.
                </p>
...
<Focus preventScroll={true}>{ref => ...}</Focus>`}
              ...
              <HashSection tag="h4" title="preserve" id="focus-preserve">
                <p>
                  The default focus behavior is to always focus the element that
                  the ref is attached to. However, if you want to preserve the
                  focus on some other element (e.g. an autofocused element),{" "}
                  <IJS>{`preserve=\{true\}`}</IJS> will stop the <IJS>ref</IJS>{" "}
                  element from claiming the focus.
                </p>
                <p>
                  This only works when the already-focused element is a child of
                  the <IJS>ref</IJS> element. If it is not a child, then the{" "}
...
// <Album className="active" />`}
          ...
          <HashSection title={<Cmp>Navigating</Cmp>} id="Navigating">
            <p>
              ...
              application is navigating and let users cancel the navigation. Its{" "}
              <IJS>children</IJS> prop is a render-invoked function that is
              passed a function to cancel the navigation.
            </p>
            <p>
              When navigation starts, <IJS>children()</IJS> will be called with
              a function that will cancel navigation when it is called.
            </p>
            <p>
            ...
            <HashSection tag="h3" title="Props" id="Navigating-props">
              <HashSection tag="h4" title="children()" id="Navigating-children">
                <p>
                  ...
                  starts and with no arguments when the navigation is finished.
                </p>
                <p>
