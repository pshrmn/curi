            ...
            <SideBySide>
              <Explanation>
                ...
                <Note>
                  ...
                  <IJS>@curi/react-dom</IJS> must be descendants of the
      ...
      {navigating ? <Spinner /> : null}
                ...
                <SideBySide>
                  <Explanation>
                    ...
                    <Warning>
                      ...
                      renders an anchor). There are accessibility issues that
                      will occur when you use other DOM elements as links. The
          ...
          <Section title={<Cmp>Focus</Cmp>} id="Focus">
            <SideBySide>
              <Explanation>
                <p>
                  <Cmp>Focus</Cmp> lets you focus a DOM element whenever there
                  is a new response. Its <IJS>children</IJS> prop is a
                  render-invoked function that receives a React ref, which
                  should be attached to the DOM component that you want to be
                  focused.
                </p>
                <p>
            ...
            <SideBySide>
              <Explanation>
                <p>
                  ...
                  partially filled form. This <strong>will not</strong> prevent
                  the user from navigating to another site, it only works for
