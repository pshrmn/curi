        ...
        <APIBlock>
          <HashSection tag="h3" title="staticFiles()" id="staticFiles">
            <p>
              ...
              files for a static website and save them to the disk. An HTML file
              will be created for each page that you provide.
            </p>
            <p>
  ...
  pages
              ...
              <HashSection tag="h5" title="router" id="staticFiles-router">
                ...
                <HashSection tag="h6" title="routes" id="staticFiles-routes">
                  <p>
                    <IJS>routes</IJS> is an array of route descriptors. This is
                    the same array that you would use to create a router in
                    client-side code.
                  </p>
    ...
    routes
                ...
                >
                  <p>
                    ...
                    options for a router. This is only necessary if you need to
                    use route interactions, side effects, or other route
                    options.
                  </p>
                  <p>
                    When you call <IJS>staticFiles()</IJS>, a router is created
                    for each page. <IJS>staticFiles()</IJS> creates its own{" "}
    ...
    getRouterOptions
              ...
              <HashSection tag="h5" title="fallback" id="staticFiles-fallback">
                <p>
                  ...
                  should generate page contents for and the <IJS>filename</IJS>{" "}
                  to save the file as.
                </p>
  ...
  fallback: {
    ...
    filename: "404.html"
              ...
              <HashSection tag="h5" title="output" id="staticFiles-output">
                <p>
                  The <IJS>output</IJS> property is used to describe how output
                  files are generated and where they are stored.
                </p>
    ...
    dir: "dist"
                ...
                >
                  <p>
                    ...
                    <IJS>redirects</IJS> to <IJS>true</IJS>, HTML files will be
                    generated for redirect pages.
                  </p>
                  <p>
                  ...
                  <Note>
                    <p>
                      ...
                      If you are using setting <IJS>emitRedirects</IJS> to{" "}
                      <IJS>false</IJS> in your client side code, your
          ...
          <HashSection tag="h3" title="pathnames()" id="pathnames">
            <p>
              The <IJS>pathnames()</IJS> function is used to generate pathnames
              from an array of provided page descriptors. This can be useful for
...
const paths = pathnames({
  ...
  pages
              ...
              >
                <p>
                  The options for a router, predominantly useful for passing any
                  route interactions the application may need while rendering.
                </p>
