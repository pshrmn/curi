            ...
            <SideBySide>
              <Explanation>
                <p>
                  ...
                  the `route` option, which will add an <IJS>ancestors()</IJS>{" "}
                  function to the router's route interactions.
                </p>
                <p>
                  The interaction returns the name of an ancestor route a given
                  level "up" from the route. If no level is provided, then it
                  will return an array of the names of all ancestor routes (from
                  most ancient to parent).
                </p>
              </Explanation>
              <CodeBlock>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>level</td>
                        <td>
                          a number of levels "up" to get the ancestor name of.
                          If this argument is not provided, the interaction will
                          return an array of all ancestor routes names (from
                          most ancient to parent).
                        </td>
                      </tr>
                    </tbody>
