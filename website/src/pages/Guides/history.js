...
const browserHistory = Browser();`}
            ...
            <p>
              ...
              be hosted on a server that can handle dynamic requests. This
              either means:
            </p>
            <ol>
              <li>
              ...
              <li>
                ...
                request doesn't map to a real file on the server (e.g. with
                NGINX or Apache).
              </li>
              <li>
                Using a static file host that can be configured to respond with
                a fallback page.
              </li>
            </ol>
          </Explanation>
...
const hashHistory = Hash();`}
          ...
          <Explanation>
            <p>
              ...
              running in a browser. It should only be used if you cannot
              configure the server to respond to requests that don't match files
              on the server.
            </p>
            <Warning>
      ...
      <Section title="Navigation" id="navigation">
        ...
        <Explanation>
          ...
          <p>
            ...
            the Curi router has a wrapper implementation, so you shouldn't need
            to call <IJS>history.navigate()</IJS> yourself.
          </p>
        </Explanation>
        <CodeBlock>
