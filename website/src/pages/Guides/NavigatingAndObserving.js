...
export default function NavigationAndObservingGuide({ name }) {
  return (
    <BaseGuide>
      <h1>{name}</h1>
      <SideBySide>
...
index = 3`}
        ...
        <Subsection title="Navigation with the Router" id="with-router">
          <SideBySide>
            <Explanation>
              <p>
                In the above examples, navigation is done using URL pathnames,
                but one of the principles of Curi is that you shouldn't have to
                write URLs yourself. To help with this, the router has its own{" "}
              ...
              <p>
                ...
                properties can also be provided to pass any of those location
                details.
              </p>
              <p>
                ...
                <IJS>"PUSH"</IJS>/<IJS>"REPLACE"</IJS> navigation, you can
                provide the type with the <IJS>method</IJS> property.
              </p>
            </Explanation>
            <CodeBlock>
              {`router.navigate({
      ...
      <Section title="Detecting Navigation" id="detecting-navigation">
        ...
        <Subsection title="Response Handlers" id="response-handlers">
          <SideBySide>
            <Explanation>
              <p>
                When response handlers are called, they are passed an object
          ...
          <SideBySide>
            <Explanation>
              <p>
                ...
                <IJS>router.once()</IJS> and <IJS>router.observe()</IJS>.
                Response handlers registered with <IJS>router.once()</IJS> will
                only be called one time, while those registered with{" "}
                <IJS>router.observe()</IJS> will be called for every new
                response.
              </p>
              <p>
                ...
                You should rarely need to do this, but it can be useful for
                memory management if you are adding and removing lots of
                observers.
              </p>
            </Explanation>
            <CodeBlock>
...
router.once(setup);`}
          ...
          <Subsection title="Rendering" id="rendering">
            <SideBySide>
              <Explanation>
                <p>
                  Rendering libraries need to know when there is a new response
                  so that they can re-render the application.
                </p>
                <p>
                ...
                <p>
                  ...
                  or you are writing your own framework implementation, you
                  would use <IJS>router.observer()</IJS> to re-render new
                  responses.
                </p>
              </Explanation>
              <CodeBlock>
            ...
            <SideBySide>
              <Explanation>
                <p>
                  ...
                  These can be useful for tasks that are not rendering related
                  as well as for tasks that need to be performed after a render
                  has completed.
                </p>
                <p>
                  The{" "}
                ...
                <p>
                  ...
                  package adds this behavior by scrolling the page to the
                  element that matches the new response's hash (<IJS>
                    response.location.hash
                  </IJS>) after the new response has rendered.
                </p>
                <p>
                  If you need to add logging to your application, you could
                  write your own observer to do this. Your observer can either
                  be added as a side effect when the router is constructed or
                  later using <IJS>router.observe()</IJS>.
                </p>
              </Explanation>
              <CodeBlock>
