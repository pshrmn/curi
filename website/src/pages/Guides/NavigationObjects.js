...
export default function NavigationObjectGuide({ name }) {
  return (
    <BaseGuide>
      <h1>{name}</h1>
      ...
      <Section title="Usage" id="usage">
        <SideBySide>
          <Explanation>
            ...
            <p>
              One usage of it would be to display a Pinterest/Twitter style
              modal. You could render the background using the previous response
              while rendering the modal using the new response.
            </p>
            <p>
