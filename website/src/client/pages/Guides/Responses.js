    ...
    <SideBySide>
      <Explanation>
        <p>
          ...
          matches a location. Some of these properties are set automatically,
          while others can be modified using the object returned a route's{" "}
      ...
      <SideBySide>
        <Explanation>
          <p>
            ...
            location. A response always has these proeprties.
          </p>
        </Explanation>
        <CodeBlock>
          {`// match properties
        ...
        <SideBySide>
          <Explanation>
            <p>
              ...
              <IJS>redirectTo</IJS> property to be emitted. The default behavior
              is to emit them, but this also means that you have to render using
  ...
  emitRedirects: false
    ...
    <Section title="The Body Property" id="body-property">
      <SideBySide>
        <Explanation>
          <p>
            The <IJS>body</IJS> property of a response is likely the most
            important property of a <IJS>response</IJS> because it is what you
            will actually render. This value can be anything you want it to be,
            but it should usually be a function/component or an object
            containing functions/components.
          </p>
          <Note>
            It is important that each route uses the same structure for setting
            the body. Mixing structures will make rendering more difficult.
          </Note>
        </Explanation>
        <CodeBlock>
          {`{
