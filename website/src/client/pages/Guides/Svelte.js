...
export default function SvelteGuide({ name }) {
  return (
    <BaseGuide>
      <h1>{name}</h1>
          ...
          <Explanation>
            ...
            <p>
              ...
              <Link to="Guide" params={{ slug: "navigating" }} hash="observer">
                observer
              </Link>, so that whenever there is a new response, the parts of
              your application that use the response will be re-rendered.
            </p>
          </Explanation>
          <CodeBlock lang="jsx">
          ...
          <SideBySide>
            <Explanation>
              <p>
                ...
                <IJS>response.body</IJS> to render the appropriate component for
                a <IJS>response</IJS>.
              </p>
              <p>
        ...
        <SideBySide>
          <Explanation>
            <p>
              ...
              within an application. When it renders in the DOM, it will render
              as an anchor (<Cmp>a</Cmp>) element.
            </p>
            <p>
