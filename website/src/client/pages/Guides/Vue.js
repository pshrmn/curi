...
export default function VueGuide({ name }) {
  return (
    <BaseGuide>
      <h1>{name}</h1>
        ...
        <SideBySide>
          <Explanation>
            <p>
              ...
              router with a Vue application. The plugin sets up a reactive
              object for tracking responses using an{" "}
            ...
            <p>
              ...
              component in your application through the <IJS>$curi</IJS>{" "}
              property.
            </p>
          </Explanation>
          <CodeBlock lang="jsx">
          ...
          <SideBySide>
            <Explanation>
              <p>
                ...
                <Cmp>component :is</Cmp> syntax. If you set Vue components as
                the <IJS>body</IJS> properties on your responses, you can
                combine <Cmp>component :is</Cmp> and <IJS>response.body</IJS> to
                render the appropriate component for a <IJS>response</IJS>.
              </p>
              <p>
          ...
          <SideBySide>
            <Explanation>
              ...
              <p>
                ...
                remember that you want every route to set the same{" "}
                <IJS>body</IJS> shape. Otherwise, you'll have to determine the
                shape and change how you render, which can quickly become messy.
              </p>
            </Explanation>
            <CodeBlock lang="html">
              {`<script>
          ...
          <SideBySide>
            <Explanation>
              <p>
                ...
                <IJS>navigation</IJS> object (the <IJS>previous</IJS> response
                and the navigation <IJS>action</IJS>) is globally available
                through <IJS>$curi.navigation</IJS>
              </p>
              <p>
          ...
          <SideBySide>
            <Explanation>
              <p>
                ...
                users who use screen readers. The <IJS>curi-focus</IJS>{" "}
                directive provides a convenient way to focus a page's main
                content when it renders a new response.
              </p>
              <p>
      ...
      <Section title="Navigating" id="navigating">
        <SideBySide>
          <Explanation>
            ...
            <p>
              The <Cmp>curi-link</Cmp>'s <IJS>to</IJS> prop describes which
              route clicking the link should navigate to. If you pass an invalid
              route name, Curi will warn you.
            </p>
            <p>
        ...
        <SideBySide>
          <Explanation>
            <p>
              ...
              <IJS>query</IJS>, and <IJS>state</IJS> props to attach their
              values to the location that will be navigated to.
            </p>
          </Explanation>
          <CodeBlock lang="jsx">
