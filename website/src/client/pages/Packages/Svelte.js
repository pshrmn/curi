      ...
      <SideBySide>
        <Explanation>
          <p>
            ...
            component that has any global layout and uses the response to render
            the correct component(s). Assuming you setup your store using{" "}
            <IJS>curiStore</IJS>, the components can access the router using{" "}
            <IJS>$router</IJS> and the response and navigation using{" "}
