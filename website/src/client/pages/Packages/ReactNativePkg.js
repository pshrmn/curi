            ...
            <Section tag="h3" title="Props" id="curiProvider-props">
              <Subsection tag="h4" title="children" id="curiProvider-render">
                <SideBySide>
                  <Explanation>
                    <p>
                      <IJS>children</IJS> is a render-invoked function. When it
                      is called, it will be passed an object with three
                      properties:
                    </p>
                    <table>
                      <thead>
                      ...
                      <tbody>
                        <tr>
                          <td>response</td>
                          <td>
                            the response object generated for the current
                            location
                          </td>
                        </tr>
                        <tr>
            ...
            <SideBySide>
              <Explanation>
                <p>
                  ...
                  <Cmp>TouchableHighlight</Cmp>, but you can also provide
                  another component. When the rendered element is touched, it
                  will use the router's <IJS>history</IJS> object to change
                  locations, which will trigger a re-render.
                </p>

                <p>
                  With the <Cmp>Link</Cmp>, instead of providing a URI to
                  navigate to, you specify the name of the route that you want
                  to link to. Then, the pathname of the URI you want the
                ...
                <SideBySide>
                  <Explanation>
                    <p>
                      ...
                      parents) include path parameters, you can specify them
                      using the params prop.
                    </p>
                  </Explanation>
                  <CodeBlock lang="jsx">
                ...
                <SideBySide>
                  <Explanation>
                    <p>
                      ...
                      <IJS>hash</IJS>, and <IJS>state</IJS> props are used to
                      pass these values.
                    </p>
                  </Explanation>
                  <CodeBlock lang="jsx">
            ...
            <Section tag="h3" title="Props" id="curious-props">
              <Subsection tag="h4" title="children" id="curious-children">
                <SideBySide>
                  <Explanation>
                    <p>
                      A render-invoked function that returns a React element.
                      This function will receive an object with{" "}
                      <IJS>router</IJS>, <IJS>response</IJS> and{" "}
...
// <Photo className="inactive" />`}
                ...
                <SideBySide>
                  <Explanation>
                    <p>
                      The second argument passed to the render-invoked function
                      is the current <IJS>response</IJS>. <Cmp>Active</Cmp> only
                      checks if the route is active (i.e. matches the current
                      location's <IJS>pathname</IJS>). If you want to check if
                      the <IJS>query</IJS> or <IJS>hash</IJS>, you should do
                      this yourself inside of the render-invoked function. You
                      can compare the <IJS>query</IJS>/<IJS>hash</IJS> against
                      the response's <IJS>location</IJS>.
                    </p>
                  </Explanation>
                  <CodeBlock lang="jsx">
                    {`<Active name="Home">
                ...
                <SideBySide>
                  <Explanation>
                    <p>
                      ...
                      routes to be considered active. Defaults to{" "}
                      <IJS>false</IJS>.
                    </p>
                  </Explanation>
                  <CodeBlock lang="jsx">
...
// <Album className="active" />`}
          ...
          <Section title={<Cmp>Block</Cmp>} id="Block">
            <SideBySide>
              <Explanation>
                <p>
                  The <Cmp>Block</Cmp> component lets you prevent navigation
                  until a user has confirmed that they want to navigate. This
                  can be useful when the user attempts to navigate away from a
                ...
                <SideBySide>
                  <Explanation>
                    <p>
                      ...
                      <IJS>true</IJS>, the navigation will be blocked. When it
                      is <IJS>false</IJS>, navigation will not be blocked.
                    </p>
                  </Explanation>
                  <CodeBlock lang="jsx">
...
<Block active={false} confirm={confirm} />`}
              ...
              <Subsection tag="h4" title="confirm" id="Block-confirm">
                <SideBySide>
                  <Explanation>
                    <p>
                      The confirm prop is a function that will be called
                      whenever there is navigation.
                    </p>
                    <table>
                      <thead>
                        <tr>
